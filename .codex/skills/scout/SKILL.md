---
name: scout
description: Fast codebase scouting using parallel agents. Use for file discovery, task context gathering, quick searches across directories. Supports internal (Explore) and external (Gemini/Codex) agents.
version: 1.0.0
---
...
- `ext`: Scout using external Gemini/Codex CLI tools in parallel (`./references/external-scouting.md`)
...
- **External:** `references/external-scouting.md` (Gemini/Codex)
...
- `references/external-scouting.md` - Using Gemini/Codex CLI
