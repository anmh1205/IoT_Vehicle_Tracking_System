...
IGNORABLE_ERROR_PATTERNS.append("esp-tls: couldn't get hostname for :")
IGNORABLE_ERROR_PATTERNS.append("transport_base: Failed to open a new connection:")
IGNORABLE_ERROR_PATTERNS.append("mqtt_client: Error transport connect")
IGNORABLE_ERROR_PATTERNS.append("mqtt_client: Client has not connected")
IGNORABLE_ERROR_PATTERNS.append("TRACKER_MQTT: MQTT error type=")
IGNORABLE_ERROR_PATTERNS.append("STATE_MACHINE: retry step=tracker_mqtt_subscribe_commands")
IGNORABLE_ERROR_PATTERNS.append("esp-tls: [sock=")
