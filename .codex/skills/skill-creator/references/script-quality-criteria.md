...
2. `$CODEX_HOME/skills/<skill-name>/.env` (skill-specific)
3. `$CODEX_HOME/skills/.env` (shared skills)
4. `$CODEX_HOME/.env` (global)
5. `./.codex/skills/${SKILL}/.env` (cwd)
6. `./.codex/skills/.env` (cwd)
7. `./.codex/.env` (cwd)
...
load_dotenv('$CODEX_HOME/.env')
load_dotenv('$CODEX_HOME/skills/.env')
load_dotenv('$CODEX_HOME/skills/my-skill/.env')
load_dotenv('./.codex/skills/my-skill/.env')
load_dotenv('./.codex/skills/.env')
