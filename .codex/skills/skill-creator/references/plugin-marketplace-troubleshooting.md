...
- Check `.codex-plugin/marketplace.json` exists at specified path
...
|-------|-------|----------|
| `File not found: .codex-plugin/marketplace.json` | Missing manifest | Create `.codex-plugin/marketplace.json` with required fields |
