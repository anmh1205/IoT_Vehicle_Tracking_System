...
Build and host plugin marketplaces to distribute Codex extensions across teams and communities.
...
Create `.codex-plugin/marketplace.json` in repository root.
...
https://code.codex.com/docs/en/plugin-marketplaces.md
