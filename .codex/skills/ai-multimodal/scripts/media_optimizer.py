...
def load_env_files():
    ...
    2. .codex/skills/ai-multimodal/.env (skill-specific config)
    3. .codex/skills/.env (shared skills config)
    ...
    skill_dir = script_dir.parent  # .codex/skills/ai-multimodal
    skills_dir = skill_dir.parent   # .codex/skills
