...
The skill is located at `.codex/skills/markdown-novel-viewer/`.
...
```json
{
  "command": "node .codex/skills/markdown-novel-viewer/scripts/server.cjs --dir \"path\" --host 0.0.0.0 --open --foreground",
