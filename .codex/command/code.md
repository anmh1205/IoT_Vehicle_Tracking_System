...
```bash
node .codex/scripts/set-active-plan.cjs {plan-folder}
```
Example: `plans/260108-1418-custom-domain-refactor/phase-01-database.md` → run `node .codex/scripts/set-active-plan.cjs plans/260108-1418-custom-domain-refactor`
