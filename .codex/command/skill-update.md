...
## Your mission
Update an existing skill or its reference files in `.codex/skills/${SKILL}` directory based on the user's prompt. 
...
### Scopes
- Project-scope: Current working project directory (e.g. `.codex/`)
- User-scope: Home/user directory (e.g. `$CODEX_HOME/`)

## IMPORTANT NOTES:
- ALWAYS make changes to skills in the project-scope `.codex/skills/` directory (UNLESS you're allowed to).
- DO NOT make any changes to skills in the home/user-scope `$CODEX_HOME/skills/` directory (UNLESS you're allowed to).
