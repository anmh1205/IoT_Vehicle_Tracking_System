...
```bash
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "<product-type>" --domain product
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "<style-keywords>" --domain style
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "accessibility" --domain ux
python3 .codex/skills/ui-ux-pro-max/scripts/search.py "z-index animation" --domain ux
```
