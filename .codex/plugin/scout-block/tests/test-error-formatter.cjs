...
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.codex').includes('.ckignore'));
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.codex/.ckignore');
