...
**IMPORTANT**: Analyze the list of skills  at `.codex/skills/*` and intelligently activate the skills that are needed for the task during the process.
...
Example:
```bash
node .codex/scripts/set-active-plan.cjs ai_docs/feature/GH-88-add-authentication
```
