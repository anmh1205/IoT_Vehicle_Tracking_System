...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `./.codex/rules/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `./.codex/rules/development-rules.md` and `./docs/code-standards.md`
