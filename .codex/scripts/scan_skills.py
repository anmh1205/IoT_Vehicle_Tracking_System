#!/usr/bin/env python3
"""
Scan .codex/skills directory and extract skill metadata.
"""
...
def scan_skills(base_path: Path) -> List[Dict]:
    ...
    for skill_file in sorted(base_path.rglob('SKILL.md')):
        ...
        try:
            ...
            skills.append({
                'name': skill_name,
                'path': str(skill_file.relative_to(Path('.codex/skills'))),
...
def main():
    ...
    output_path = Path('.codex/scripts/skills_data.yaml')
