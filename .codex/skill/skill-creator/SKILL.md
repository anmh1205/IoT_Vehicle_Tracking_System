...
**IMPORTANT:**
- Skills are not documentation, they are practical instructions for Codex to use the tools, packages, plugins or APIs to achieve the tasks.
- Each skill teaches Claude how to perform a specific development task, not what a tool does.
- Codex can activate multiple skills automatically to achieve the user's request.
...
- Descriptions in metadata of `SKILL.md` files should be both concise (less than 200 characters) and still contains enough usecases of the references and scripts, this will help skills can be activated automatically during the implementation process of Codex.
...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `.codex/skills/${SKILL}/.env` > `.codex/skills/.env` > `.codex/.env` 
...
**Why?**
Better **context engineering**: leverage **progressive disclosure** technique of Agent Skills, when agent skills are activated, Codex will consider to load only relevant files into the context, instead of reading all long `SKILL.md` as before.
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `.codex/skills/docs-seeker/.env` > `.codex/skills/.env` > `.codex/.env`
...
**IMPORTANT:**
- Referenced markdown files should be also **less than 100 lines**, remember that you can always split them into multiple files (**progressive disclosure** principle).
- Referenced markdown files are practical instructions for Codex to use the tools, packages, plugins or APIs to achieve the tasks.
- Each skill teaches Claude how to perform a specific development task, not what a tool does.
...
## References
- [Agent Skills](https://docs.codex.com/en/docs/claude-code/skills.md)
- [Agent Skills Spec](.codex/skills/agent_skills_spec.md)
- [Agent Skills Overview](https://docs.codex.com/en/docs/agents-and-tools/agent-skills/overview.md)
