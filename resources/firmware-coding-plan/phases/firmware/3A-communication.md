...
- [22-backend-mqtt-bridge.md](../../../cloud-coding-plan/22-backend-mqtt-bridge.md) — Bridge payload contract
- [firmware-development-plan.md](../../../../design-reports/firmware-development-plan.md) — Phase 4
