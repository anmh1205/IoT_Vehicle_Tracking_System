...
| LTE + GNSS           | SIMCom SIM7600CE-T             | Tích hợp cao, đi dây gọn, đồng bộ firmware |
...
- **Tầng thiết bị (Device Layer):** ESP32-S3 + SIM7600CE-T (LTE + GNSS) + vgate iCar Pro + LIS3DH, quản lý nguồn thông minh với pin dự phòng 21700
