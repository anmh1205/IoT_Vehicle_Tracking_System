...
phối hợp đúng khi ghép thành một hệ thống hoàn chỉnh hay không. Điều này cũng có nghĩa khối
lượng công việc của đồ án không dừng ở một nguyên mẫu hẹp, mà trải rộng qua nhiều nhóm việc vốn
thường được chia cho các vai trò khác nhau trong một nhóm R\&D: thiết kế phần cứng, phát triển
firmware ESP-IDF, tổ chức dữ liệu và microservice, thiết lập hạ tầng tự vận hành, cùng xây dựng
quy trình kiểm thử và phát hành liên tầng.
...
hình thành từ thiết bị đến giao diện quản trị. Ngay cả ở bản rút gọn này, có thể thấy đồ án đã bao
phủ phạm vi công việc rộng và tiêu chuẩn thực hiện cao: tự thiết kế phần cứng, tự phát triển
firmware ESP-IDF có tổ chức, tự dựng hệ thống dịch vụ kiểu microservice, tự triển khai hạ tầng VPS,
tự thiết lập quan sát vận hành và CI/CD, thay vì phụ thuộc vào các nền tảng dựng sẵn hay dịch vụ
ngoài như AWS hoặc Vercel. Có thể tóm lược theo bốn tầng chính như sau:
...
Chương này trình bày bản rút gọn của các quyết định thiết kế cốt lõi. Trọng tâm là giữ rõ chuỗi lập luận: bài toán kỹ thuật, tiêu chí lựa chọn, phương án được chọn và tác động tới kết quả triển khai ở Chương 4. Dù rút gọn, chương vẫn cần làm rõ rằng phạm vi thiết kế của đồ án không chỉ là chọn linh kiện hay chọn framework, mà là đồng thời chốt kiến trúc cho một hệ thống IoT hoàn chỉnh gồm thiết bị phần cứng, firmware chuẩn ESP-IDF, chuỗi dịch vụ cloud tách vai trò rõ ràng, giao diện vận hành và hạ tầng tự chủ phục vụ triển khai thực tế.
...
Chương 4 tập trung vào những gì đã triển khai và những gì đã đo được. Phần mô tả chi tiết từng dòng lệnh, từng endpoint và cấu trúc mã nguồn được lược bỏ; thay vào đó là bằng chứng triển khai, số liệu đo lường trọng yếu và đối chiếu với chỉ tiêu thiết kế. Điểm cần nhấn mạnh là phần triển khai của đồ án không chỉ dừng ở mức "chạy được" từng thành phần, mà đã đi tới bước build-up một hệ thống nhiều lớp theo hướng chuyên nghiệp: từ chế tạo phần cứng, hoàn thiện firmware, tổ chức backend và frontend, đến dựng hạ tầng VPS, quy trình phát hành và cơ chế giám sát phục vụ vận hành thử nghiệm.
...
Chương 5 trình bày bản đánh giá rút gọn theo nguyên tắc: giữ chỉ số then chốt, bỏ các bảng so sánh dư thừa và tập trung vào ý nghĩa vận hành của kết quả. Tuy nhiên, phần đánh giá không chỉ nhằm kết luận từng thành phần "đạt" hay "chưa đạt", mà còn để chỉ ra rằng giá trị của đồ án nằm ở năng lực hoàn thiện đồng thời nhiều lớp kỹ thuật với mức độ tự chủ cao: không phụ thuộc nền tảng cloud dựng sẵn, có tổ chức dịch vụ rõ ràng, có khả năng quan sát vận hành và có tư duy phát triển gần với cách một đội kỹ thuật sản phẩm thực hiện dự án thực tế.
...
Chương 6 tóm tắt các bài học cốt lõi rút ra từ quá trình thực hiện đồ án, tập trung vào năng lực giải quyết vấn đề kỹ thuật liên ngành và tính thực tiễn khi chuyển từ thiết kế sang vận hành. Từ góc nhìn tổng thể, bài học quan trọng nhất không chỉ là giải một bài toán kỹ thuật riêng lẻ, mà là cách phối hợp nhiều miền chuyên môn trong cùng một đồ án: từ điện tử và hệ nhúng, qua dữ liệu và microservice, tới triển khai VPS, CI/CD và giám sát vận hành. Chính độ rộng đó cho thấy đồ án có khối lượng và chiều sâu công việc tương đương một phạm vi mà trong môi trường doanh nghiệp thường cần nhiều vai trò cùng tham gia.
