...
kiến trúc tích hợp, gồm ba lớp chính: thiết bị gắn trên xe để thu thập
và truyền dữ liệu, hệ thống máy chủ để tiếp nhận và xử lý dữ liệu, và
giao diện theo dõi để người quản lý quan sát tình trạng đội xe. Cách tổ
chức này giúp liên kết dữ liệu từ phương tiện với nhu cầu theo dõi và ra
quyết định trong vận hành thực tế.
...
nhiệm truyền dữ liệu qua mạng di động và định vị vệ tinh GNSS để xác
định vị trí xe; LIS3DSH theo dõi rung động để nhận biết chuyển động khi
xe đỗ; còn adapter vgate iCar Pro cho phép đọc dữ liệu chẩn đoán OBD2 từ
xe qua BLE. Kiến trúc nguồn được tổ chức theo nhiều nhánh để thiết bị
vẫn duy trì hoạt động khi xe tắt máy, đồng thời hạn chế ảnh hưởng tới ắc
quy chính.

Ở tầng xử lý dữ liệu, các bản tin từ thiết bị trước hết được tiếp nhận
bởi lớp truyền thông trung tâm, rồi được phân loại theo từng nhóm thông
tin như dữ liệu vận hành, trạng thái thiết bị, sự kiện cảnh báo và tiến
trình cập nhật phần mềm từ xa. Từ đó, dữ liệu được chuẩn hóa và chuyển
đến các lớp lưu trữ, xử lý nghiệp vụ và cập nhật thời gian thực, để vừa
phục vụ giám sát tức thời vừa hỗ trợ tra cứu lịch sử và quản trị hệ
thống.

Ở tầng ứng dụng, bảng điều khiển web được xây dựng để người quản lý theo
 dõi vị trí xe, trạng thái thiết bị, lịch sử hành trình và các cảnh báo
trên cùng một giao diện thống nhất. Dữ liệu mới được máy chủ đẩy lên
trình duyệt khi có thay đổi, nhờ đó người vận hành có thể quan sát diễn
biến của đội xe gần như theo thời gian thực thay vì phải tải lại dữ liệu
thủ công.
...
thuê xe tự lái trong nước: chi phí hợp lý, có thể tùy biến và còn dư địa
mở rộng trong các giai đoạn tiếp theo.
...
Vì đề tài đi qua đồng thời các tầng mạch nguồn, phần mềm nhúng trên thiết bị, hạ tầng
máy chủ, dịch vụ backend, giao diện quản trị và lớp vận hành triển khai,
rủi ro lớn nhất không nằm ở việc từng khối có chạy riêng lẻ hay không, mà ở việc chúng có còn
phối hợp đúng khi ghép thành một hệ thống hoàn chỉnh hay không. Một lựa chọn ở tầng nguồn vì thế
không chỉ ảnh hưởng tới độ ổn định của bo mạch, mà còn chi phối khả năng giữ phiên làm việc của
modem, nhịp truyền bản tin, tính liên tục của dữ liệu đi lên máy chủ và cuối cùng là độ tin cậy của
thông tin hiển thị cho người vận hành.
...
các khối đã lắp xong, mà như bằng chứng cho thấy một chuỗi giá trị kỹ thuật hoàn chỉnh đã được
hình thành từ thiết bị đến giao diện quản trị. Trong chuỗi đó, mỗi tầng chỉ có ý nghĩa khi giữ được
sự ăn khớp với tầng còn lại: phần cứng phải đủ bền và đủ ổn định để firmware duy trì trạng thái làm
việc, firmware phải tổ chức dữ liệu và phục hồi kết nối đủ tốt để lớp máy chủ tiếp nhận nhất quán,
và lớp máy chủ phải xử lý, lưu trữ và phát dữ liệu đủ đúng lúc để giao diện còn hỗ trợ được quyết
định vận hành. Có thể tóm lược theo bốn tầng chính như sau:
...
Chương này trình bày bản rút gọn của các quyết định thiết kế cốt lõi. Trọng tâm là giữ rõ chuỗi lập luận: bài toán kỹ thuật, tiêu chí lựa chọn, phương án được chọn và tác động tới kết quả triển khai ở Chương 4. Theo cách đó, việc chọn phần cứng không thể tách khỏi chiến lược năng lượng và khả năng giao tiếp của firmware; việc chọn kiến trúc dữ liệu không thể tách khỏi nhịp telemetry, cơ chế cảnh báo và nhu cầu quan sát vận hành ở phía giao diện.
...
Chương 4 tập trung vào những gì đã triển khai và những gì đã đo được. Phần mô tả chi tiết từng dòng lệnh, từng endpoint và cấu trúc mã nguồn được lược bỏ; thay vào đó là bằng chứng triển khai, số liệu đo lường trọng yếu và đối chiếu với chỉ tiêu thiết kế. Trình tự trình bày của chương vì thế đi từ phần cứng, firmware, lớp máy chủ đến giao diện không phải để tách chúng thành các khối độc lập, mà để cho thấy mỗi lớp chỉ được xem là hoàn thành khi nó còn giữ được luồng làm việc xuyên suốt với các lớp còn lại trong điều kiện thử nghiệm thực tế.
...
Chương 5 trình bày bản đánh giá rút gọn theo nguyên tắc: giữ chỉ số then chốt, bỏ các bảng so sánh dư thừa và tập trung vào ý nghĩa vận hành của kết quả. Vì vậy, các nhận xét trong chương không dừng ở việc một chỉ số riêng lẻ đạt hay chưa đạt, mà đặt từng kết quả vào bối cảnh vận hành toàn tuyến: phần cứng có còn giữ nguồn đủ ổn định cho firmware, firmware có còn giữ được nhịp dữ liệu cho lớp máy chủ, và lớp máy chủ có còn cung cấp được phản hồi đủ nhanh và đủ tin cậy cho người dùng cuối.
...
Chương 6 tóm tắt các bài học cốt lõi rút ra từ quá trình thực hiện đồ án, tập trung vào năng lực giải quyết vấn đề kỹ thuật liên ngành và tính thực tiễn khi chuyển từ thiết kế sang vận hành. Các bài học này được hình thành không phải từ từng phần tách rời, mà từ quá trình phải giữ cho quyết định ở tầng phần cứng, firmware, dữ liệu, dịch vụ và giám sát vận hành còn thống nhất với nhau khi hệ thống đi vào tích hợp và kiểm thử.
