...
LIS3DH theo dõi rung động để nhận biết chuyển động khi xe đỗ; còn
...
LIS3DH (IMU), DS3231M (RTC), W25Q128 (SPI Flash), and power blocks based
...
LIS3DH & Thiết kế PCB, chế tạo và tích hợp thiết bị hoàn chỉnh \\\hline
...
SIM7600CE-T, cảm biến rung LIS3DH và adapter OBD2. Lớp giữa làm nhiệm
...
Cảm biến gia tốc & LIS3DH & --- & Phát hiện chuyển động và rung \\\hline
...
\item
  ...
  + GNSS SIMCom SIM7600CE-T, cảm biến gia tốc LIS3DH, khối nguồn đa
...
thái ngủ sâu để giảm tiêu thụ điện, và chỉ IMU LIS3DH duy trì giám sát
...
trong khi vẫn duy trì khả năng phát hiện xâm nhập. IMU LIS3DH đảm nhiệm
...
2 & IC cảm biến LIS3DH & Cái & 1 & 40.000 & Cảm biến gia tốc 3
trục \\\hline
3 & vgate iCar Pro (OBD2 BLE) & Cái & 1 & 367.000 & BLE 4.0,
ELM327 compatible \\\hline
4 & SIMCom SIM7600CE-T & Bá»™ & 1 & 650.000 & Modem LTE + GNSS
tích hợp \\\hline
...
\item
  ...
  IMU (LIS3DH qua I2C), modem SIM7600CE-T (UART1, Auto mode
...
41 & LIS3DH\_INT & Input & Ngắt từ cảm biến gia tốc IMU \\\hline
2 & \nolinkurl{LIS3DH_SDA} & I/O & Đường dữ liệu I2C \\\hline
1 & \nolinkurl{LIS3DH_SCL} & I/O & Đường clock I2C \\\hline
...
chỉnh & NVS \\\hline
IMU (LIS3DH) & Đặt thiết bị trên mặt phẳng, đo offset các trục X/Y/Z &
NVS \\\hline
...
chá»§}\label{3131-ux111ux1eb7t-vux1ea5n-ux111ux1ec1-cho-kiux1ebfn-truxfac-cloud}
...
Cảm biến IMU & LIS3DH & Tiết kiệm điện và có thể tự đánh thức khi phát
...
\item
  ...
  + LIS3DH, phối hợp để lấy dữ liệu xe, lấy vị trí và quản lý nguồn với
...
GPIO 41 & LIS3DH\_INT & Input (Interrupt) & Nhận tín hiệu ngắt từ cảm
biến gia tốc LIS3DH khi phát hiện chuyển động \\\hline
GPIO 2 & \nolinkurl{LIS3DH_SDA} & I/O (I2C) & Đường dữ liệu I2C kết nối với cảm
biến LIS3DH \\\hline
GPIO 1 & \nolinkurl{LIS3DH_SCL} & I/O (I2C) & Đường xung nhịp I2C kết nối với cảm
biến LIS3DH \\\hline
...
\item
  ...
  \textit{light sleep}. Với wiring production hiện tại, chân GPIO 41 (LIS3DH\_INT)
...
4 & SIMCom SIM7600CE-T & Bá»™ & 1 & 650.000 & Modem LTE Cat-4
tích hợp GNSS \\\hline
5 & Pin 18650 1S Li-ion 3500mAh & Cái & 1 & 79.000 & Loại có
protection board \\\hline
6 & IC sạc TP5100 + mạch phụ trợ & Cái & 1 & 25.000 & Input 5V
...
ESP32-S3-WROOM-1, LIS3DH và các linh kiện liên quan lên PCB
...
biến LIS3DH trên I2C (GPIO2, GPIO1), và hiệu chuẩn mạch đo điện áp ắc
quy tại GPIO4 (ADC).
...
BLE, đọc I2C từ LIS3DH. Kiểm tra chuyển nguồn tự động bằng cách thay
đổi điện áp đầu vào.
...
\item
  ...
  cảm biến LIS3DH trả về dữ liệu qua I2C, kết nối BLE với OBD2 adapter
  thành công.
\end{itemize}
...
\item
  ...
  khi xe đỗ, và đánh thức đúng khi phát hiện rung động (qua LIS3DH)
...
41 & LIS3DH\_INT & Input & Ngắt từ cảm biến gia tốc IMU \\\hline
2 & \nolinkurl{LIS3DH_SDA} & I/O & I2C data line \\\hline
1 & \nolinkurl{LIS3DH_SCL} & I/O & I2C clock line \\\hline
26 & \nolinkurl{MODEM_PWR-KEY} & Output & Điều khiển nguồn modem \\\hline
\end{longtable}
}
...
ngá»§}\label{4235-triux1ec3n-khai-quux1ea3n-luxfd-nguux1ed3n-vuxe0-chux1ebf-ux111ux1ed9-ngux1ee7}
...
\NormalTok{    gpio\_wakeup\_enable}\OperatorTok{(}\NormalTok{LIS3DH\_INT}\OperatorTok{,}\NormalTok{ GPIO\_INTR\_HIGH\_LEVEL}\OperatorTok{);}
...
{\thesissettableid{4.5-cloud}{tab-ch4-mapping-domain-va-port-cong-khai-moi-truong-thu-nghiem}
\def\LTcaptype{table}
...
\item
  ...
  lõi ESP32-S3 + LIS3DH do còn có tổn hao từ mạch nguồn, đường cấp
...
chá»§}\label{434-kux1ebft-quux1ea3-kiux1ec3m-thux1eed-hux1ec7-thux1ed1ng-cloud}

\paragraph{4.3.4.1. Hiệu suất API phía máy
chá»§}\label{4341-hiux1ec7u-suux1ea5t-api-backend}
...
IC cảm biến LIS3DH & Cảm biến gia tốc (IMU) & 40.000 \\\hline
...
\item
  ...
  SPI/I2C để giao tiếp với cảm biến gia tốc LIS3DH, cấu hình các thanh
...
{[}23{]} STMicroelectronics, "LIS3DH - MEMS Digital Output Motion
...
{[}24{]} STMicroelectronics, "LIS3DH Application Note AN3308," Rev. 2,
2020.
...
4 & Cảm biến gia tốc & IC LIS3DH & 1 & 40.000 & 40.000 & IMU 3 trục,
