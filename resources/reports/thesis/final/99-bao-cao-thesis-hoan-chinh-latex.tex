...
\AtEndEnvironment{longtable}{\let\\\thesislongtableorignewline}
\usepackage{graphicx}
\makeatletter
...
\newcommand{\safeincludesvg}[1]{%
  ...
  \IfFileExists{\safeincludepngpath}{\includegraphics[width=0.74\linewidth,keepaspectratio]{\safeincludepngpath}}{%
    \IfFileExists{#1}{\includesvg[width=0.74\linewidth,keepaspectratio]{#1}}{%
...
\newcommand{\safeincludesvgsmall}[1]{%
  \StrSubstitute{#1}{.svg}{.png}[\safeincludepngpath]%
  \IfFileExists{\safeincludepngpath}{\includegraphics[width=0.56\linewidth,keepaspectratio]{\safeincludepngpath}}{%
    \IfFileExists{#1}{\includesvg[width=0.56\linewidth,keepaspectratio]{#1}}{%
      \fbox{\parbox{0.9\linewidth}{\centering Missing figure file:\\ \texttt{\detokenize{#1}}}}%
    }%
  }%
}
...
\hline
Giải pháp & Chi phí thiết bị & Phí dịch vụ hàng tháng & Tổng chi phí năm
đầu & Khả năng tùy biến \\
\hline
\endhead
\hline
\endlastfoot
