...
\makeatother
\usepackage{svg}
\svgsetup{inkscapeformat=pdf,inkscapelatex=false}
\newcommand{\safeincludesvg}[1]{%
  \IfFileExists{#1}{\includesvg[keepaspectratio]{#1}}{%
    \fbox{\parbox{0.9\linewidth}{\centering Missing figure file:\\ \texttt{\detokenize{#1}}}}%
  }%
}
...
\newcommand{\majorheading}[1]{\clearpage\section*{#1}}
\newcommand{\chapterheading}[1]{\clearpage\section*{#1}\setcounter{subsection}{0}}
...
{\Large\textbf{ĐỒ ÁN TỐT NGHIỆP}}\\[0.8cm]
{\Large\textbf{THIẾT KẾ HỆ THỐNG IOT CHO ỨNG DỤNG QUẢN LÝ}}\\
{\Large\textbf{PHƯƠNG TIỆN GIAO THÔNG TRONG LĨNH VỰC}}\\
{\Large\textbf{CHO THUÊ XE TỰ LÁI}}
\vfill
...
\begin{tabular}{ll}
\textbf{Sinh viên:} & \textbf{Lê Trọng An} \\
\textbf{Mã số sinh viên:} & \textbf{21010389} \\
\textbf{Lớp:} & \textbf{K15-KTCĐT2} \\
\textbf{Ngành:} & \textbf{Kỹ thuật Cơ điện tử} \\
\textbf{Giảng viên hướng dẫn:} & \textbf{TS. Nguyễn Đức Nam} \\
\end{tabular}
\end{center}
\clearpage
...
\thispagestyle{empty}
\begin{center}
\textbf{PHENIKAA UNIVERSITY}\\
\textbf{FACULTY OF MECHANICAL ENGINEERING AND MECHATRONICS}
\vspace*{2cm}

\textbf{MEM710071 -- CAPSTONE DESIGN 2}
\vspace*{1.8cm}

{\Large\textbf{DESIGN OF AN IOT SYSTEM FOR VEHICLE MANAGEMENT}}\\
{\Large\textbf{IN SELF-DRIVE CAR RENTAL SERVICES}}
\vfill

\begin{tabular}{ll}
\textbf{Student:} & \textbf{Le Trong An} \\
\textbf{Student ID:} & \textbf{21010389} \\
\textbf{Supervisor:} & \textbf{Dr. Nguyen Duc Nam} \\
\end{tabular}
\end{center}
\clearpage

\majorheading{NHẬN XÉT ĐỒ ÁN TỐT NGHIỆP CỦA GIẢNG VIÊN HƯỚNG DẪN}
...
\textbf{Khoa:} & Cơ khí - Cơ Điện tử \\
\textbf{Tên đề tài:} & Thiết kế hệ thống IoT cho ứng dụng quản lý phương
tiện giao thông trong lĩnh vực cho thuê xe tự lái \\
\textbf{Sinh viên thực hiện:} & Lê Trọng An \\
\textbf{Lớp:} & K15-KTCĐT2 \\
\end{longtable}
}
...
\textbf{II. Nhận xét về tinh thần và thái độ làm việc của sinh viên:}

.............................

\textbf{III. Kết quả đạt được:}

.............................

\textbf{IV. Kết luận:}

\checkbox\ Đồng ý cho bảo vệ \thesisspacer \checkbox\ Không đồng ý cho bảo vệ
...
\majorheading{NHẬN XÉT ĐỒ ÁN TỐT NGHIỆP CỦA GIẢNG VIÊN PHẢN BIỆN}
...
\majorheading{BIÊN BẢN ĐÁNH GIÁ ĐỒ ÁN TỐT NGHIỆP}
...
\item
  Địa điểm: .............................
\item
  Họ và tên sinh viên: Lê Trọng An \thesisspacer Mã số SV: 21010389
\item
  Lớp: K15-KTCĐT2 \thesisspacer Ngành: Kỹ thuật Cơ điện tử \thesisspacer Khóa: K15
\item
...
\textbf{III. Tổng hợp câu hỏi của thành viên hội đồng:}
.............................

\textbf{IV. Tổng hợp nội dung trả lời của sinh viên:}
.............................
...
\textbf{VI. Điểm kết luận:} .............. (Bằng chữ: ..............)

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\majorheading{GIẢI TRÌNH CÁC CHỈNH SỬA}
...
\frontmatterstart
\majorheading{LỜI CAM ĐOAN}\label{lux1eddi-cam-ux111oan}

Tôi xin cam đoan đồ án tốt nghiệp với đề tài \textbf{"Thiết kế hệ thống
IoT cho ứng dụng quản lý phương tiện giao thông trong lĩnh vực cho thuê
xe tự lái"} là công trình nghiên cứu của riêng tôi dưới sự hướng dẫn của
TS. Nguyễn Đức Nam.

Các số liệu, kết quả trình bày trong đồ án là trung thực và chưa từng
được công bố trong bất kỳ công trình nghiên cứu nào khác. Các tài liệu
tham khảo, trích dẫn trong đồ án đều được ghi rõ nguồn gốc.

Tôi xin chịu hoàn toàn trách nhiệm về nội dung đồ án tốt nghiệp của
mình.
...
\textbf{Đề tài:} Thiết kế hệ thống IoT cho ứng dụng quản lý phương tiện
giao thông trong lĩnh vực cho thuê xe tự lái

\textbf{Sinh viên thực hiện:} Lê Trọng An \thesisspacer \textbf{MSSV:} 21010389
...
Về phần cứng, hệ thống sử dụng ESP32-S3 làm bộ xử lý trung tâm, kết hợp
modem LTE + GNSS SIMCom SIM7600CE-T để định vị và truyền dữ liệu. Modem
được cấu hình ở chế độ Auto (\texttt{AT+CNMP=2}) để tự động chuyển giữa
LTE/UMTS/GSM, dùng APN mặc định \texttt{internet} và cung cấp dữ liệu
GNSS qua \texttt{AT+CGNSINF} hoặc luồng NMEA tùy chọn
\texttt{AT+CGNSTST} trên cùng UART1, nên không cần thêm module GNSS độc
lập. Thiết bị đọc dữ liệu OBD2 qua adapter vgate iCar Pro bằng BLE, đồng
thời sử dụng IMU LIS3DSH để phát hiện rung động và hỗ trợ phân tích hành
vi vận hành. Khối nguồn gồm buck/boost converter, bộ sạc pin dự phòng
18650 1S Li-ion 3500mAh, BMS và cơ chế ngắt điện áp thấp (LVD), giúp
thiết bị vẫn hoạt động khi xe tắt máy.
...
\textbf{Title:} Design of an IoT System for Vehicle Management in
Self-Drive Car Rental Services

\textbf{Student:} Lê Trọng An \thesisspacer \textbf{Student ID:} 21010389

\textbf{Supervisor:} Dr. Nguyen Duc Nam
...
On the hardware side, the system employs the ESP32-S3 microcontroller as
the central processing unit, paired with the SIMCom SIM7600CE-T LTE+GNSS
modem. The modem is configured to Auto mode (\texttt{AT+CNMP=2}) so it
can switch between LTE/UMTS/GSM automatically, uses the default APN
\texttt{internet}, and delivers GNSS data via \texttt{AT+CGNSINF} (with
optional NMEA streaming through \texttt{AT+CGNSTST}) on the same UART1
channel without a dedicated GNSS interface. The device reads engine
diagnostic data via the OBD2 protocol through a vgate iCar Pro adapter
using Bluetooth Low Energy (BLE), while integrating the LIS3DSH IMU
accelerometer for motion detection and abnormal parking-state alerts.
The power management system includes buck/boost converters, a 18650 1S
Li-ion 3500mAh backup battery charger path with BMS protection, and a
low-voltage disconnect (LVD) mechanism to ensure continuous operation
even when the vehicle engine is off.
...
\majorheading{MỤC LỤC - TABLE OF CONTENTS}\label{mux1ee5c-lux1ee5c---table-of-contents}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}{|C{0.10\linewidth}|L{0.72\linewidth}|C{0.12\linewidth}|}
\hline
\textbf{STT} & \textbf{Nội dung} & \textbf{Trang} \\
\hline
\endhead
\hline
\endlastfoot
...
\textbf{Chương 1} & \textbf{GIỚI THIỆU DỰ ÁN - SUMMARY} & ... \\
1.1 & Đặt vấn đề / Bối cảnh của dự án --- Problem definition and
Background & ... \\
...
\textbf{Chương 2} & \textbf{PHÂN TÍCH VẤN ĐỀ KỸ THUẬT} & ... \\
2.1 & Mô tả vấn đề --- Problem statement & ... \\
2.2 & Bối cảnh và cơ sở kỹ thuật --- Background and Technical reviews &
... \\
2.3 & Yêu cầu kỹ thuật và các tiêu chuẩn thiết kế --- Design criteria
and Constraints & ... \\
2.4 & Yêu cầu từ các bên liên quan --- Constituent\textquotesingle s
requirements & ... \\
\textbf{Chương 3} & \textbf{CÁC GIẢI PHÁP THIẾT KẾ - DESIGN SOLUTIONS} &
... \\
...
3.3 & Phân tích, đánh giá và lựa chọn phương án khả thi --- Analysis,
Evaluation and Selection & ... \\
3.4 & Tối ưu phương án thiết kế --- The optimal solution & ... \\
\textbf{Chương 4} & \textbf{TRIỂN KHAI GIẢI PHÁP VÀ KẾT QUẢ -
...
\textbf{Chương 5} & \textbf{ĐÁNH GIÁ VÀ KHUYẾN NGHỊ - EVALUATION AND
RECOMMENDATION} & ... \\
...
\textbf{Chương 6} & \textbf{PHẢN HỒI VÀ BÀI HỌC KINH NGHIỆM - REFLECTION
AND CASE-STUDIES} & ... \\
6.1 & Ứng dụng kiến thức kỹ thuật --- Earlier course work & ... \\
6.2 & Giải quyết các vấn đề kỹ thuật phức tạp --- Complex engineering
problems & ... \\
6.3 & Tác động đạo đức và xã hội --- Ethical and Social impacts & ... \\
6.4 & Tổng kết và bài học kinh nghiệm --- General reflection and
case-studies & ... \\
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}{|C{0.15\linewidth}|L{0.67\linewidth}|C{0.12\linewidth}|}
\hline
\textbf{Bảng} & \textbf{Mô tả} & \textbf{Trang} \\
\hline
\endhead
\hline
\endlastfoot
...
\majorheading{DANH MỤC HÌNH ẢNH VÀ ĐỒ THỊ - LIST OF PICTURES AND GRAPHS}\label{danh-mux1ee5c-huxecnh-ux1ea3nh-vuxe0-ux111ux1ed3-thux1ecb---list-of-pictures-and-graphs}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}{|C{0.15\linewidth}|L{0.67\linewidth}|C{0.12\linewidth}|}
\hline
\textbf{Hình} & \textbf{Mô tả} & \textbf{Trang} \\
\hline
\endhead
\hline
\endlastfoot
...
... \\
Hình 2.1 & Sơ đồ kiến trúc dữ liệu của hệ thống - Data Architecture
Diagram & ... \\
...
... \\
Hình 3.9 & Lưu đồ điều phối modem SIM7600CE-T theo trạng thái mạng và
chế độ vận hành & ... \\
...
Hình 3.14a & Luồng điều phối OTA giữa Backend, EMQX, thiết bị và MQTT
Bridge & ... \\
Hình 3.15 & Sơ đồ kiến trúc Feature-Sliced Design của ứng dụng Frontend
& ... \\
Hình 3.15a & Luồng dữ liệu một chiều giữa Next.js, Query, Zustand và
Backend & ... \\
Hình 3.16 & Biểu đồ trình tự (Sequence Diagram) luồng xác thực người
dùng & ... \\
...
Hình 4.3 & Sơ đồ mạch đo điện áp ắc quy bằng voltage divider và ADC
ESP32-S3 & ... \\
Hình 4.4 & Sơ đồ nguyên lý mạch điện tổng hợp của hệ thống tracker &
... \\
Hình 4.5 & Sơ đồ đấu nối tổng thể giữa ESP32-S3 và các khối phần cứng
tích hợp & ... \\
...
... \\
Hình 4.16a & Chuỗi bước OTA trên firmware từ nhận lệnh đến xác nhận sau
reboot & ... \\
...
Hình 4.32 & Đồ thị dòng tiêu thụ theo thời gian trong một chu kỳ hoạt
động hoàn chỉnh (Driving -\textgreater{} Parking -\textgreater{} Alert
-\textgreater{} Parking) & ... \\
Hình 4.33 & Đồ thị điện áp pin dự phòng theo thời gian trong kiểm thử
tracking liên tục & ... \\
Hình 4.34 & Đồ thị dòng tiêu thụ theo nhiệt độ môi trường & ... \\
Hình 4.35 & Biểu đồ phân bố thời gian kết nối BLE OBD2 (20 lần đo) &
... \\
Hình 4.36 & Đồ thị thời gian bắt vệ tinh GPS trong các kịch bản
(Cold/Warm/Hot Start) & ... \\
Hình 4.37 & Biểu đồ phân bố độ trễ MQTT trong điều kiện mạng 4G ổn định
& ... \\
Hình 4.38 & Biểu đồ thời gian phản hồi API (P50, P95, P99) cho các
endpoint chính & ... \\
...
... \\
Hình 4.42 & Screenshot giao diện Dashboard hiển thị vị trí xe đang di
chuyển trên bản đồ (Leaflet) & ... \\
Hình 4.43 & Screenshot biểu đồ dữ liệu OBD2 thời gian thực (ECharts) -
RPM, Speed, Coolant Temp & ... \\
Hình 4.44 & Screenshot cảnh báo Geofence trên giao diện Dashboard với
bản đồ hiển thị vùng cảnh báo & ... \\
Hình 4.45 & Screenshot giao diện gửi lệnh điều khiển từ Dashboard và kết
quả phản hồi từ thiết bị & ... \\
Hình 4.46 & Screenshot hành trình trên bản đồ, thể hiện giai đoạn gián
đoạn và tiếp tục cập nhật sau khi phục hồi kết nối & ... \\
Hình 4.47 & Biểu đồ radar so sánh chỉ tiêu thiết kế và kết quả đạt được
(spider chart) & ... \\
...
\majorheading{DANH MỤC TỪ VIẾT TẮT - LIST OF ABBREVIATIONS}\label{danh-mux1ee5c-tux1eeb-viux1ebft-tux1eaft---list-of-abbreviations}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}{|C{0.18\linewidth}|L{0.37\linewidth}|L{0.37\linewidth}|}
\hline
...
thực \\
\textbf{SoC} & System on Chip & Hệ thống trên chip \\
\textbf{SQL} & Structured Query Language & Ngôn ngữ truy vấn có cấu
trúc \\
\textbf{TLS} & Transport Layer Security & Bảo mật tầng vận chuyển \\
\textbf{UART} & Universal Asynchronous Receiver-Transmitter & Bộ thu
phát bất đồng bộ đa năng \\
...
\mainmatterstart
\chapterheading{CHƯƠNG 1. GIỚI THIỆU DỰ ÁN -- SUMMARY}
...
\emph{Hình 1.1: Sơ đồ tổng quan vấn đề và giải pháp đề xuất}
...
LIS3DSH & Thiết kế PCB, chế tạo và tích hợp thiết bị hoàn chỉnh \\
...
\bottomrule\noalign{}
\endlastfoot
1 & Tiêu thụ điện chế độ ngủ sâu (deep sleep) & \textless{} 500 µA \\
2 & Tiêu thụ điện chế độ hoạt động & \textless{} 250 mA (trung bình) \\
3 & Thời gian thức dậy từ deep sleep & \textless{} 3 giây \\
...
ON=12.2V; Profile 24V: OFF=24.0V, ON=24.4V \\
...
3 & Thời gian kết nối OBD2 BLE & \textless{} 10 giây \\
4 & Độ chính xác vị trí GNSS & \textless{} 5 mét (điều kiện thoáng) \\
...
\bottomrule\noalign{}
\endlastfoot
1 & Độ trễ xử lý MQTT message & \textless{} 500 ms (end-to-end) \\
2 & Số lượng thiết bị đồng thời & \textgreater= 100 thiết bị \\
3 & Độ sẵn sàng hệ thống (uptime) & \textgreater= 99.5\% \\
4 & Thời gian phản hồi API & \textless{} 200 ms (p95) \\
5 & Lưu trữ dữ liệu telemetry & \textgreater= 90 ngày \\
...
\bottomrule\noalign{}
\endlastfoot
1 & Cập nhật bản đồ thời gian thực & \textless{} 2 giây độ trễ \\
...
\emph{Hình 1.2: Quy trình phát triển dự án theo các giai đoạn}
...
\emph{Hình 1.3: Kiến trúc tổng thể hệ thống IoT Vehicle Tracking}
...
\emph{Hình 1.4: Sơ đồ chuyển đổi giữa các chế độ năng lượng}
...
\emph{Hình 1.5: Lộ trình phát triển dự án theo các giai đoạn (Roadmap)}
...
\toprule\noalign{}
Tiêu chí & Giám sát thủ công & GPS Tracker đơn giản & Fleet Management
thương mại & Hệ thống đề xuất \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
Chi phí thiết bị & Không & 500.000--1.500.000 VND & 1.000.000--5.000.000
VND & 870.000--1.630.000 VND \\
Phí dịch vụ hàng tháng & Không & 50.000--100.000 VND & 200.000--500.000
VND & Chi phí 4G SIM (\textasciitilde70.000 VND) \\
Độ chính xác vị trí & Thấp (báo cáo thủ công) & Trung bình (GPS) & Cao
(GPS + A-GPS) & Cao (GNSS đa hệ thống) \\
...
Hỗ trợ bi-directional & Có (Subscribe) & Không (cần Polling/WebSocket) &
Có (Observe) \\
...
\emph{Hình 2.1: Sơ đồ kiến trúc dữ liệu của hệ thống - Data Architecture
Diagram}
...
\subsection{2.4. Yêu cầu từ các bên liên quan --
Constituent\textquotesingle s
requirements}\label{24-yuxeau-cux1ea7u-tux1eeb-cuxe1c-buxean-liuxean-quan--constituents-requirements}
...
thiết bị (online/offline); Quản lý người dùng và phân quyền & Cao \\
...
low, thiết bị offline) & Trung bình \\
...
thông báo về trạng thái đơn thuê & Thấp (Phase 2) \\
\end{longtable}
}
...
{[}Bảng 2.6: Ma trận truy xuất yêu cầu các bên liên quan với chức năng
hệ thống{]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
Yêu cầu bên liên quan & FC-01 (Vị trí) & FC-02 (OBD2) & FC-03 (Bất
thường) & FC-04 (Năng lượng) & FC-05 (Web) \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
Hệ thống tracker được tổ chức theo kiến trúc module với năm khối chức
năng chính, trong đó ESP32-S3 đóng vai trò điều phối trung tâm. Sơ đồ
...
\emph{Hình 3.1: Sơ đồ khối tổng thể hệ thống tracker}

\begin{quote}
Nguồn: Hình vẽ của tác giả
\end{quote}

\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-01.svg}}

\emph{Hình 3.1a: Phân rã chi tiết các khối chức năng của tracker}
...
cơ bật (IGN ON), các module cần thiết được kích hoạt; (2) chế độ đỗ xe
--- khi động cơ tắt (IGN OFF), ESP32 chuyển sang deep sleep và chỉ IMU
LIS3DSH duy trì giám sát chuyển động; (3) chế độ cảnh báo --- khi IMU
...
tiếp bởi module tích hợp SIMCom SIM7600CE-T (GNSS nội bộ) trên cùng UART
với LTE; và dữ liệu chuyển động thu từ IMU LIS3DSH qua I2C. ESP32-S3
tổng hợp, đóng gói và truyền toàn bộ dữ liệu lên máy chủ qua MQTT thông
qua kết nối 4G/LTE của SIM7600CE-T.
...
Thay vì chấm điểm tổng quát, Bảng 3.1 đối chiếu trực tiếp các ràng buộc
...
thiếu serial cho debug \\
Chi phí triển khai phần cứng tham chiếu &
\textasciitilde100.000--200.000 VND (mặt bằng BOM dự án) &
\textasciitilde150.000--300.000 VND (mặt bằng BOM dự án) & Thường cao
hơn ESP32-S3 và ít phổ biến hơn trong bối cảnh dự án \\
...
sơ tiêu thụ nguồn và mức độ thuận lợi khi phát triển firmware. Bảng 3.3
...
& Giảm số module phần cứng rời, thuận lợi cho đi dây và lắp ráp \\
\end{longtable}
}
...
bằng \texttt{AT+CGNSINF} \\
Điện áp cấp nguồn & 3.4--4.2 V, điển hình 3.8 V {[}60{]} \\
Ý nghĩa tích hợp & Giảm số linh kiện rời, đơn giản hóa đi dây và đồng bộ
với firmware thực tế \\
Ghi chú & APN mặc định sử dụng trong hệ thống là \texttt{internet}; pin
mapping phần cứng giữ nguyên \\
\end{longtable}
}

\subsection{3.2. Đề xuất các giải pháp -- Proposed multiple
solutions}\label{32-ux111ux1ec1-xuux1ea5t-cuxe1c-giux1ea3i-phuxe1p--proposed-multiple-solutions}

\subsubsection{3.2.1. Giải pháp phần
cứng}\label{321-giux1ea3i-phuxe1p-phux1ea7n-cux1ee9ng}

\paragraph{3.2.1.1. Thiết kế mô-đun thu thập dữ liệu
...
{[}Bảng 3.5: So sánh phương pháp kết nối OBD2 theo thông số triển
khai{]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}lll@{}}
\toprule\noalign{}
Tiêu chí kỹ thuật & OBD2 có dây (ELM327 UART) & OBD2 không dây (BLE
...
tracker & Không cần dây giữa tracker và cổng OBD2 \\
Giao thức tới MCU & UART TTL & BLE 4.0 GATT; vgate iCar Pro là bản
Bluetooth 4.0 BLE {[}29{]}, {[}64{]} \\
Tài nguyên MCU tiêu tốn & Chiếm thêm 1 UART phần cứng trong lúc kết nối
& Tận dụng BLE tích hợp của ESP32-S3, giữ UART cho modem/GNSS/debug \\
...
công bố tự sleep sau khoảng 30 phút khi xe tắt máy {[}64{]} \\
Hành vi wake & Phụ thuộc adapter và đường cấp nguồn & Vendor quảng bá tự
khởi động khi ignition ON; cần hiểu là hành vi phụ thuộc xe {[}64{]} \\
...
dòng active/standby, nên không chốt số mA trong luận văn {[}64{]} \\
...
Chỉ cần rút/cắm adapter và cấu hình lại kết nối nếu cần \\
\end{longtable}
}
...
\emph{Hình 3.2: Sơ đồ kết nối BLE giữa ESP32-S3 và vgate iCar Pro}
...
\paragraph{3.2.1.2. Thiết kế mô-đun cảm biến chuyển động
...
\emph{Hình 3.3: Sơ đồ kết nối LIS3DSH với ESP32-S3 qua I2C}

\begin{quote}
Nguồn: Hình vẽ của tác giả
\end{quote}

\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-02.svg}}

\emph{Hình 3.3a: Sơ đồ chi tiết chân kết nối LIS3DSH với ESP32-S3}
...
\emph{Hình 3.4: Sơ đồ khối hệ thống quản lý nguồn}

\begin{quote}
Nguồn: Hình vẽ của tác giả
\end{quote}

\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-03.svg}}

\emph{Hình 3.4a: Kiến trúc nguồn và phân phối điện áp trong hệ thống}

\begin{quote}
Nguồn: Hình vẽ UML kỹ thuật của tác giả
\end{quote}

\subparagraph{a) Buck 3.3V cho ESP32-S3 (XL1509
3.3E)}\label{a-buck-33v-cho-esp32-s3-xl1509-33e}

Nhánh buck 3.3V dùng \textbf{XL1509 3.3E} để hạ điện áp từ ắc quy xe
...
\bottomrule\noalign{}
\endlastfoot
Buck 3.8V & TPS54231 & 12--24V & \textasciitilde4V & SIM7600CE-T \\
\end{longtable}
}
...
\textasciitilde3.7V). Khối \textbf{SX1308} tăng áp lên 5V để duy trì cấp
nguồn cho hệ thống.
...
\bottomrule\noalign{}
\endlastfoot
Boost 5V & SX1308 & Battery \textasciitilde3.7V & 5V & Backup từ pin \\
\end{longtable}
}
...
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
Trạng thái & IGN & U\_batt & Nguồn tracker & Sạc pin & Cảnh báo \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
Xe chạy bình thường & ON & Profile 12V: U\_batt \textgreater= 13.0V;
Profile 24V: U\_batt \textgreater= 26.0V & Ắc quy & Có & Không \\
Xe đỗ bình thường & OFF & Profile 12V: U\_batt \textgreater{} 12.0V;
Profile 24V: U\_batt \textgreater{} 24.0V & Ắc quy & Không & Không \\
...
Ngoài kênh ADC, tín hiệu trạng thái LVD từ comparator LM393 được đưa về
...
giản, giữ nguyên kiến trúc 1S Li-ion + TP4056 + BMS + SX1308 của hệ
thống.
...
Năng lượng & \textasciitilde12.95 Wh \\
...
\item
  Thời gian hoạt động: T = 3150 / 7.1 = 444 giờ \textasciitilde{}
  \textbf{18.5 ngày}
\end{itemize}
...
\tightlist
\item
  Dòng trung bình: \textasciitilde5 mA
\item
  Thời gian hoạt động: T = 3150 / 5 = 630 giờ \textasciitilde{}
  \textbf{26 ngày}
\end{itemize}
...
\tightlist
\item
  Dòng trung bình: \textasciitilde250 mA
\item
...
output 4.2V, dòng theo PROG \\
7 & Mạch buck XL1509 3.3V & Cái & 1 & 15.000--30.000 & 12--24V
-\textgreater{} 3.3V cấp ESP32-S3 \\
8 & Mạch buck MP2482 5V & Cái & 1 & 15.000--30.000 & Bus 5V chính \\
9 & Mạch buck TPS54231 \textasciitilde4V & Cái & 1 & 20.000--40.000 &
12--24V -\textgreater{} \textasciitilde4V cấp modem SIM7600CE-T \\
10 & Mạch boost SX1308 5V backup & Cái & 1 & 10.000--20.000 & Backup từ
pin 18650 1S \\
11 & Comparator LM393 & Cái & 1 & 5.000--15.000 & Giám sát LVD
(GPIO19) \\
12 & Diode Schottky 1N5822 & Cái & 2 & 2.000--5.000 & Diode-OR power
path \\
13 & BMS/Protection Board 1S & Cái & 1 & 10.000--20.000 & Bảo vệ pin
18650 1S \\
...
header \\
17 & PCB 2 lớp (\textasciitilde50x50 mm) & Cái & 1 & 50.000--100.000 &
Bo mạch theo layout của đề tài \\
...
670.000--1.250.000 \\
B & Quản lý nguồn (XL1509, MP2482, TPS54231, SX1308, TP4056, diode OR,
LM393, BMS) & 80.000--155.000 \\
C & Linh kiện phụ trợ (điện trở, tụ, diode, connector) &
42.000--75.000 \\
D & PCB và vỏ (tùy chọn) & 100.000--200.000 \\
& \textbf{Tổng cộng} & \textbf{872.000--1.635.000} \\
\end{longtable}
}
...
bình \\
\textbf{PA-FW2: ESP-IDF + FreeRTOS (Đã chọn)} & Kiến trúc task/event,
...
module hóa & Tính chuẩn hóa tốt, khả năng mở rộng dài hạn & Hệ sinh thái
...
\item
  ...
  bộ và primitive đồng bộ ở mức module, phù hợp với bài toán IoT chạy
  trên tài nguyên hạn chế.
\item
...
\texttt{ble\_obd} & Trừu tượng hóa phần cứng và giao thức ngoại vi \\
...
thái vận hành, lệnh điều khiển và luồng OTA \\
4 & \texttt{data\_formatter}, \texttt{mqtt\_client} & Đóng gói payload
JSON, publish/subscribe MQTT theo topic chuẩn của hệ thống \\
...
\emph{Hình 3.5: Sơ đồ kiến trúc phân lớp của firmware}
...
\emph{Hình 3.6: Sơ đồ tương tác giữa các FreeRTOS task}
...
\emph{Hình 3.7: Lưu đồ thuật toán luồng hoạt động chính của firmware}
...
\emph{Hình 3.8: Lưu đồ thuật toán quy trình kết nối và đọc dữ liệu BLE
OBD2}
...
\bottomrule\noalign{}
\endlastfoot
1 & \texttt{AT} & Kiểm tra modem còn phản hồi \\
2 & \texttt{AT+CPIN?} & Kiểm tra SIM card đã sẵn sàng \\
3 & \texttt{AT+CNMP=2} & Đặt chế độ tự động LTE/UMTS/GSM \\
4 & \texttt{AT+CGDCONT=1,"IP","internet"} & Cấu hình PDP context với APN
mặc định \texttt{internet} \\
5 & \texttt{AT+CEREG?} & Poll đến khi \texttt{+CEREG:\ 0,1} (hoặc
\texttt{stat}=5) trước khi kích hoạt PDP context \\
...
vệ tinh); \texttt{AT+CGNSTST} chỉ dùng nếu cần dữ liệu NMEA hoàn toàn \\
\end{longtable}
}
...
\texttt{AT+CGACT=0,1} rồi \texttt{AT+CGACT=1,1} để tái khởi động PDP \\
GNSS không fix dù đã bật & Gọi lại \texttt{AT+CGNSINF}, nếu vẫn thất bại
thì bật lại GNSS (\texttt{AT+CGNSPWR=0}/\texttt{1}) rồi thử lại \\
Modem quá nóng & Đưa \texttt{AT+CFUN=0} để tạm thời tắt RF và chờ nhiệt
độ giảm trước khi tiếp tục \\
\end{longtable}
}
...
\emph{Hình 3.9: Lưu đồ điều phối modem SIM7600CE-T theo trạng thái mạng
và chế độ vận hành}
...
\bottomrule\noalign{}
\endlastfoot
2 & IGN\_IN & Input & Đọc trạng thái động cơ (GPIO hoặc OBD2) \\
4 & U\_BATT\_ADC & Input & Đọc điện áp ắc quy (ADC 12-bit) \\
5 & CHARGER\_EN & Output & Điều khiển IC sạc TP4056 \\
18 & POWER\_PATH\_EN & Output & Chọn nguồn cấp (ắc quy hoặc pin dự
phòng) \\
19 & LVD\_STATUS & Input & Đọc trạng thái LVD từ comparator LM393 \\
21 & LIS3DSH\_INT & Input & Ngắt từ cảm biến gia tốc IMU \\
47 & LIS3DSH\_SDA & I/O & Đường dữ liệu I2C \\
48 & LIS3DSH\_SCL & I/O & Đường clock I2C \\
16 & MODEM\_UART\_TX & Output & UART TX đến modem \\
17 & MODEM\_UART\_RX & Input & UART RX từ modem \\
26 & MODEM\_PWR-KEY & Output & Điều khiển nguồn modem \\
\end{longtable}
}
...
\emph{Hình 3.10: Lưu đồ thuật toán điều khiển power path}
...
(GPIO5 = LOW) & Ắc quy yếu, không đủ năng lượng để sạc pin dự phòng \\
\end{longtable}
}
...
Ngoài ra, hệ thống có thêm kênh giám sát LVD độc lập sử dụng comparator
LM393 (GPIO19). Đây là kênh dự phòng cho ADC, cho phép kiểm tra nhanh
...
Switch\_ON=24.4V. Comparator tự xử lý hysteresis ở mức phần cứng, tránh
hiện tượng dao động (oscillation) quanh ngưỡng.
...
\begin{longtable}[]{@{}lllll@{}}
\toprule\noalign{}
Chế độ & Trạng thái ESP32 & Trạng thái modem & Trạng thái BLE & Dòng
tiêu thụ \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\bottomrule\noalign{}
\endlastfoot
\texttt{v1/\{device\_id\}/rawdata} & Device -\textgreater{} Server & 0 &
Payload telemetry chính; tần suất cao, chấp nhận mất vài mẫu \\
\texttt{v1/\{device\_id\}/status} & Device -\textgreater{} Server & 1 &
Heartbeat, trạng thái phiên, online/offline \\
\texttt{v1/\{device\_id\}/events} & Device -\textgreater{} Server & 1 &
Cảnh báo và sự kiện quan trọng \\
\texttt{v1/\{device\_id\}/firmware} & Device -\textgreater{} Server & 1
& Tiến trình OTA và kết quả cập nhật firmware \\
\texttt{v1/\{device\_id\}/commands} & Server -\textgreater{} Device & 1
& Lệnh điều khiển và cập nhật cấu hình từ máy chủ \\
\end{longtable}
}
...
\texttt{heartbeat\_interval\_s}, \texttt{tracking\_interval\_s} \\
...
CHECK\_IGN & 1 & Kiểm tra trạng thái động cơ \\
...
\bottomrule\noalign{}
\endlastfoot
INIT & Khởi tạo hoàn tất & CHECK\_IGN \\
CHECK\_IGN & IGN = ON & DRIVING \\
CHECK\_IGN & IGN = OFF & PARKED \\
...
SLEEP & Timer wake-up hoặc IMU interrupt & CHECK\_IGN \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/04-chuong-3-giai-phap-firmware-hinh-3-11.svg}}

\emph{Hình 3.11: Sơ đồ máy trạng thái của thiết bị theo dõi}
...
lý nhiều dịch vụ Docker & \textbf{Cao (Đã chọn)} \\
\end{longtable}
}
...
\texttt{Device\ -\textgreater{}\ EMQX\ -\textgreater{}\ MQTT\ Bridge\ -\textgreater{}\ PostgreSQL/VictoriaMetrics/VictoriaLogs\ -\textgreater{}\ Backend\ API\ -\textgreater{}\ Frontend}
...
\emph{Hình 3.12: Sơ đồ kiến trúc tổng quan hệ thống Cloud}

\begin{quote}
Nguồn: Hình vẽ của tác giả
\end{quote}

\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-04.svg}}

\emph{Hình 3.12a: Luồng dữ liệu chi tiết từ thiết bị đến dashboard}
...
\bottomrule\noalign{}
\endlastfoot
Tracking\_Backend & tracking-backend & 4000 & 512MB, 1 CPU \\
Tracking\_Frontend & tracking-frontend & 4002 & 512MB, 1 CPU \\
Tracking\_MqttBridge & tracking-mqtt-bridge & - & 256MB, 0.5 CPU \\
Tracking\_PostgreSQL & tracking-postgres & 5432 & 1GB, 2 CPU \\
...
CPU \\
Tracking\_VictoriaLogs & tracking-victorialogs & 9428 & 512MB, 1 CPU \\
Tracking\_Grafana & tracking-grafana & 4001 & Chưa cấu hình cứng \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Kết nối đồng thời} & \textasciitilde1.000 &
\textasciitilde100.000.000 & \textasciitilde200.000.000 &
\textasciitilde10.000.000 \\
\textbf{Thông lượng message} & 40K msg/s & 100K msg/s & 200K msg/s & 50K
msg/s \\
\textbf{Độ trễ (Latency)} & 0,25 ms & 0,27 ms & \textless1 ms & 2,1
ms \\
\textbf{Sử dụng CPU} & Rất thấp & Thấp (2\%) & Thấp & Cao (10\%) \\
\textbf{Sử dụng RAM} & 254 MB & 495 MB & Trung bình & 1,2 GB \\
\textbf{Hỗ trợ Clustering} & Không & Có (20+ node) & Có & Có \\
\textbf{Khả dụng cao (HA)} & Không & Có & Có & Có \\
\textbf{Độ phức tạp cài đặt} & Rất dễ & Trung bình & Khó & Trung bình \\
\textbf{Chi phí} & Miễn phí & Miễn phí/Trả phí & Trả phí & Miễn phí/Trả
phí \\
\textbf{Cộng đồng} & Lớn & Lớn & Trung bình & Nhỏ \\
\end{longtable}
}
...
vấn nghiệp vụ, chi phí index/partition cao & Trung bình \\
...
quan hệ phức tạp, khó đảm bảo ràng buộc nghiệp vụ & Thấp \\
\textbf{PA-DB3: Hybrid DB (Đã chọn)} & PostgreSQL + VictoriaMetrics +
VictoriaLogs & Mỗi loại dữ liệu dùng đúng công cụ, cân bằng hiệu năng và
khả năng truy vấn & Tăng số thành phần cần vận hành & \textbf{Cao} \\
\end{longtable}
}
...
\emph{Hình 3.13: Sơ đồ chiến lược lưu trữ kép}
...
khoản, phiên đăng nhập \\
\textbf{Phương tiện \& Thiết bị} & vehicles, devices,
device\_configurations & Thông tin xe và thiết bị tracker \\
\textbf{Khách hàng} & customers & Thông tin khách hàng thuê xe \\
...
gán kết với xe \\
\textbf{Lệnh điều khiển} & commands & Lệnh gửi đến thiết bị \\
\textbf{Bảo trì} & maintenance\_records & Lịch sử bảo trì phương tiện \\
\textbf{Nhật ký} & connection\_logs, device\_status\_history & Nhật ký
kết nối và lịch sử trạng thái \\
\textbf{Thông báo} & notifications & Thông báo hệ thống \\
\textbf{Nhiên liệu} & fuel\_records & Quản lý nhiên liệu \\
\end{longtable}
}
...
\emph{Hình 3.14: Sơ đồ quan hệ cơ sở dữ liệu (ER Diagram)}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Ngôn ngữ truy vấn} & Flux (phức tạp) & PromQL (đơn giản) \\
\textbf{Hiệu năng} & Tốt & Nhanh gấp 10 lần \\
\textbf{Sử dụng RAM} & Cao & Thấp \\
\textbf{Nén dữ liệu} & Tốt & Tốt hơn (gấp 10 lần) \\
\textbf{Tương thích Prometheus} & Không & Có \\
\textbf{Độ khó học} & Cao (Flux) & Thấp (PromQL) \\
\textbf{Tích hợp Grafana} & Qua plugin & Hỗ trợ sẵn (Native) \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Độ khó học} & Rất dễ & Trung bình & Khó \\
\textbf{Linh hoạt} & Rất cao & Trung bình & Cao \\
\textbf{Hiệu năng} & Cao & Cao & Rất cao \\
\textbf{Lượng code mẫu (Boilerplate)} & Ít & Nhiều & Trung bình \\
\textbf{Hệ sinh thái IoT} & Rất tốt & Tốt & Tốt \\
\textbf{Hỗ trợ thời gian thực} & Rất tốt & Rất tốt & Tốt \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Authentication} & POST & /api/v1/auth/login & Đăng nhập &
Không \\
& GET & /api/v1/auth/me & Thông tin người dùng hiện tại & Có \\
& POST & /api/v1/auth/logout & Đăng xuất & Có \\
\textbf{Devices} & GET & /api/v1/devices & Danh sách thiết bị & Có \\
& POST & /api/v1/devices & Tạo thiết bị mới & Có \\
& POST & /api/v1/devices/:id/ota & Gửi lệnh OTA đến thiết bị & Có \\
& POST & /api/v1/devices/:id/ota/rollback & Yêu cầu rollback firmware &
Có \\
\textbf{Vehicles} & GET & /api/v1/vehicles & Danh sách xe & Có \\
& POST & /api/v1/vehicles & Tạo xe mới & Có \\
\textbf{IoT Data} & POST & /api/v1/iot/data & Gửi dữ liệu cảm biến &
Không \\
\textbf{Telemetry} & GET & /api/v1/devices/:id/telemetry & Dữ liệu
telemetry theo thiết bị & Có \\
& GET & /api/v1/telemetry/history & Truy vấn lịch sử telemetry & Có \\
\textbf{Dashboard} & GET & /api/v1/dashboard/stats & Thống kê tổng quan
& Có \\
\textbf{Firmware} & POST & /api/v1/firmware/upload & Tải lên firmware &
Có \\
...
\emph{Hình 3.14a: Luồng điều phối OTA giữa Backend, EMQX, thiết bị và
MQTT Bridge}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Thu hồi token} & Khó (cần blacklist) & Dễ (xóa khỏi DB) \\
...
ghép nhiều thành phần & Trung bình \\
...
(File-based routing) & Không có sẵn, cần thư viện bổ sung \\
...
đăng nhập, trạng thái sidebar, theme \\
...
(\textasciitilde1.1 KB) và phù hợp với yêu cầu của hệ thống nơi token
...
\emph{Hình 3.15: Sơ đồ kiến trúc Feature-Sliced Design của ứng dụng
Frontend}
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-05.svg}}

\emph{Hình 3.15a: Luồng dữ liệu một chiều giữa Next.js, Query, Zustand
và Backend}
...
\emph{Hình 3.16: Biểu đồ trình tự (Sequence Diagram) luồng xác thực
người dùng}
...
\emph{Hình 3.17: Giao diện trang Dashboard tổng quan}
...
\emph{Hình 3.18: Giao diện trang quản lý phương tiện}
...
đồ & Có (cập nhật số liệu) \\
Bản đồ & \texttt{/dashboard/map} & Theo dõi tất cả xe thời gian thực &
Có (vị trí xe) \\
Phương tiện & \texttt{/dashboard/vehicles} & CRUD xe, trạng thái, lịch
sử & Có (trạng thái xe) \\
Chuyến đi & \texttt{/dashboard/trips} & Lịch sử chuyến đi, tuyến đường &
Không \\
Cảnh báo & \texttt{/dashboard/alerts} & Xem, xử lý cảnh báo & Có (cảnh
báo mới) \\
Vi phạm & \texttt{/dashboard/violations} & Quản lý vi phạm tốc độ &
Không \\
Thiết bị & \texttt{/dashboard/devices} & Quản lý thiết bị IoT & Có
(trạng thái thiết bị) \\
Vùng địa lý & \texttt{/dashboard/geofences} & Tạo, sửa geofence trên bản
đồ & Không \\
Bảo trì & \texttt{/dashboard/maintenance} & Lịch sử bảo trì phương tiện
& Không \\
Thông báo & \texttt{/dashboard/notifications} & Cấu hình Telegram, Email
& Không \\
Cài đặt & \texttt{/dashboard/settings} & Hồ sơ, quản lý người dùng &
Không \\
\end{longtable}
}
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-06.svg}}

\emph{Hình 3.19a: Phân rã lớp bản đồ React Leaflet và kênh Socket.IO}
...
\emph{Hình 3.19: Kiến trúc tích hợp bản đồ thời gian thực}
...
\bottomrule\noalign{}
\endlastfoot
VehicleMap & \texttt{components/map/vehicle-map.tsx} & Hiển thị tất cả
xe trên bản đồ với marker và popup thông tin \\
RouteMap & \texttt{components/map/route-map.tsx} & Hiển thị tuyến đường
chuyến đi với polyline và các điểm dừng \\
GeofenceMap & \texttt{components/map/geofence-map.tsx} & Vẽ và chỉnh sửa
vùng địa lý (polygon, circle, rectangle) \\
MarkerPopup & \texttt{components/map/marker-popup.tsx} & Popup hiển thị
thông tin xe khi click marker (biển số, tốc độ, trạng thái) \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/06-chuong-3-giai-phap-frontend-hinh-3-20.svg}}

\emph{Hình 3.20: Giao diện trang bản đồ thời gian thực với các marker
xe}
...
drawer, bảng thành danh sách card, bản đồ toàn màn hình \\
Tablet & 640px - 1024px & Giao diện trung gian & Sidebar thu gọn
(icon-only), bảng giữ nguyên với cuộn ngang \\
Desktop & \textgreater{} 1024px & Giao diện đầy đủ & Sidebar mở rộng,
bảng đầy đủ cột, bản đồ chia đôi màn hình \\
\end{longtable}
}
...
\emph{Hình 3.21: Wireframe bố cục giao diện Dashboard}
...
\emph{Hình 3.22: Các mẫu thiết kế UI của hệ thống - Data Table, Form,
Charts}
...
telemetry khi mất mạng, phát lại theo thứ tự khi reconnect \\
...
\emph{Hình 3.23: Sơ đồ kiến trúc tổng thể phương án tối ưu}
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-07.svg}}

\emph{Hình 4.1a: Bố trí chi tiết các khối phần cứng trong tracker}
...
\emph{Hình 4.1: Sơ đồ khối tổng thể hệ thống tracker IoT}
...
I2C & 2 cổng \\
ADC & 12-bit, 20 kênh \\
Deep Sleep & \textasciitilde10--15 µA (với external wakeup) \\
Active (BLE) & \textasciitilde20--40 mA \\
\end{longtable}
}
...
stop bit, không parity. Kiến trúc này giảm số module phần cứng và giữ
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-08.svg}}

\emph{Hình 4.2a: Sơ đồ chân kết nối SIM7600CE-T với ESP32-S3}
...
\emph{Hình 4.2: Sơ đồ kết nối giữa ESP32-S3 và modem SIM7600CE-T qua
UART}
...
tạo tỷ lệ chia áp \textasciitilde0.0909 để đưa điện áp về dải đo ADC
(0--3.3V).
...
\emph{Hình 4.3: Sơ đồ mạch đo điện áp ắc quy bằng voltage divider và ADC
ESP32-S3}
...
\emph{Hình 4.4: Sơ đồ nguyên lý mạch điện tổng hợp của hệ thống tracker}
...
external wakeup. Bảng 4.1 trình bày chi tiết phân công chân GPIO cho
toàn bộ hệ thống.

\textbf{Bảng 4.1: Phân công chân GPIO của ESP32-S3}
...
OBD2 \\
GPIO 4 & U\_BATT\_ADC & Input (ADC) & Đọc điện áp ắc quy xe qua voltage
divider (R1=100k, R2=10k) \\
GPIO 5 & CHARGER\_EN & Output & Điều khiển bật/tắt IC sạc TP4056 (HIGH =
sạc, LOW = không sạc) \\
GPIO 16 & MODEM\_UART\_TX & Output & Truyền dữ liệu UART đến modem
SIM7600CE-T \\
GPIO 17 & MODEM\_UART\_RX & Input & Nhận dữ liệu UART từ modem
SIM7600CE-T \\
GPIO 18 & POWER\_PATH\_EN & Output & Điều khiển nhánh nguồn: LOW = ưu
tiên MP2482, HIGH = ưu tiên backup SX1308 \\
GPIO 19 & LVD\_STATUS & Input & Đọc trạng thái Low Voltage Disconnect
(HIGH = low-voltage, LOW = bình thường) \\
GPIO 21 & LIS3DSH\_INT & Input (Interrupt) & Nhận tín hiệu ngắt từ cảm
biến gia tốc LIS3DSH khi phát hiện chuyển động \\
GPIO 47 & LIS3DSH\_SDA & I/O (I2C) & Đường dữ liệu I2C kết nối với cảm
biến LIS3DSH \\
GPIO 48 & LIS3DSH\_SCL & I/O (I2C) & Đường xung nhịp I2C kết nối với cảm
biến LIS3DSH \\
GPIO 26 & MODEM\_PWR-KEY & Output & Điều khiển bật/tắt nguồn modem
SIM7600CE-T \\
\end{longtable}
}
...
chính và các khối phần cứng tích hợp trên bo mạch. Hình 4.5 đã được
...
\emph{Hình 4.5: Sơ đồ đấu nối tổng thể giữa ESP32-S3 và các khối phần
cứng tích hợp}
...
\tightlist
\item
  \textbf{Buck 3.3V (XL1509 3.3E):} Chuyển đổi 12V/24V xuống 3.3V cấp
  ESP32-S3
\item
  \textbf{Buck 5V (MP2482):} Chuyển đổi 12V/24V xuống 5V bus chính
\item
  \textbf{Buck \textasciitilde4V (TPS54231):} Chuyển đổi 12V/24V xuống
  \textasciitilde4V cấp modem SIM7600CE-T
\item
  \textbf{Boost 5V (SX1308):} Tăng áp từ pin 18650 1S
  (\textasciitilde3.7V) lên 5V dự phòng
\item
  \textbf{Power path Diode-OR + điều khiển EN:} Tự động duy trì nguồn
  liên tục giữa nhánh chính và nhánh backup
\item
  \textbf{Mạch sạc TP4056 + LVD (LM393/ADC):} Sạc pin 1S và giám sát
  ngưỡng điện áp bảo vệ ắc quy
\end{enumerate}

\pandocbounded{\safeincludesvg{./assets/figures/thesis-99-bao-cao-thesis-hoan-chinh-09.svg}}

\emph{Hình 4.6a: Kiến trúc power path giữa nguồn xe và pin dự phòng}
...
\emph{Hình 4.6: Kiến trúc tổng thể mạch quản lý nguồn}

\begin{quote}
Nguồn: Hình vẽ của tác giả
\end{quote}

\paragraph{b) Buck 3.3V cho ESP32-S3 (XL1509
3.3E)}\label{b-buck-33v-cho-esp32-s3-xl1509-33e}

Khối buck 3.3V dùng \textbf{XL1509 3.3E} để hạ áp từ 12V/24V xuống 3.3V
cấp cho ESP32-S3.

\textbf{Bảng 4.2: Khối Buck 3.3V}
...
\pandocbounded{\safeincludesvg{./assets/figures/07-chuong-4-trien-khai-hardware-hinh-4-7.svg}}

\emph{Hình 4.7: Kiến trúc nhánh buck 5V chính dùng MP2482}
...
\textbf{Bảng 4.4: Khối Buck 3.8V/4V cho modem}
...
(\textasciitilde3.7V) lên 5V khi chạy nguồn dự phòng.

\textbf{Bảng 4.5: Khối Boost 5V dự phòng}
...
\pandocbounded{\safeincludesvg{./assets/figures/07-chuong-4-trien-khai-hardware-hinh-4-8.svg}}

\emph{Hình 4.8: Kiến trúc nhánh nguồn dự phòng 5V từ pin 18650 qua
SX1308}
...
\textbf{Bảng 4.6: Logic chuyển nguồn tự động}
...
Profile 24V: U\_batt \textgreater{} 24.0V & Ắc quy & Không & Không \\
Ắc quy yếu & OFF & Profile 12V: U\_batt \textless= 12.0V; Profile 24V:
U\_batt \textless= 24.0V & Pin 18650 1S & Không & Có \\
Ắc quy phục hồi & OFF & Profile 12V: U\_batt \textgreater= 12.2V;
Profile 24V: U\_batt \textgreater= 24.4V & Ắc quy & Không & Có \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/07-chuong-4-trien-khai-hardware-hinh-4-9.svg}}

\emph{Hình 4.9: Sơ đồ power path runtime giữa nhánh chính và nhánh
backup}
...
\textbf{Bảng 4.7: Khối sạc TP4056}
...
\emph{Hình 4.10: Kiến trúc sạc pin TP4056 và đường cấp nguồn dự phòng}
...
Hệ thống dùng ADC (R1 = 100 kΩ, R2 = 10 kΩ) kết hợp comparator LM393 để
giám sát điện áp.
...
(\texttt{XL1509\ 3.3E}, \texttt{MP2482}, \texttt{TPS54231},
\texttt{SX1308}, \texttt{TP4056}, \texttt{LM393}) và cụm lưu trữ năng
lượng (\texttt{pin\ 18650\ 1S\ +\ BMS}). Hình 4.11 thể hiện cách nhóm
...
\emph{Hình 4.11: Sơ đồ bố cục bên trong vỏ hộp bảo vệ}
...
\textbf{Bảng 4.6: Danh sách vật liệu đầy đủ cho hệ thống tracker}
...
OBD2 BLE 4.0, tương thích ESP32-S3 \\
4 & SIMCom SIM7600CE-T & Bộ & 1 & 330,000--500,000 & Modem LTE Cat-4
tích hợp GNSS + anten + khe SIM \\
5 & Pin 18650 1S Li-ion 3500mAh & Cái & 1 & 100,000--200,000 & Loại có
protection board \\
6 & IC sạc TP4056 + mạch phụ trợ & Cái & 1 & 20,000--40,000 & Input 5V
từ MP2482, output 4.2V, dòng theo PROG \\
7 & Mạch buck XL1509 3.3V & Cái & 1 & 15,000--30,000 & 12--24V
-\textgreater{} 3.3V cho ESP32-S3 \\
8 & Mạch buck MP2482 5V & Cái & 1 & 15,000--30,000 & Bus 5V chính \\
9 & Mạch buck TPS54231 \textasciitilde4V & Cái & 1 & 20,000--40,000 &
12--24V -\textgreater{} \textasciitilde4V cấp modem SIM7600CE-T \\
10 & Mạch boost SX1308 5V backup & Cái & 1 & 10,000--20,000 & Backup từ
...
\textbf{Bảng 4.7: Tổng chi phí ước tính}
...
\textbf{Tổng cộng} & \textbf{870,000--1,630,000} \\
\end{longtable}
}
...
(ESP32-S3-WROOM-1, XL1509 3.3E, MP2482, TPS54231, SX1308, TP4056,
SIM7600CE-T, LM393) để bảo đảm hoạt động đúng.

\textbf{Bước 2 - Lắp ráp khối nguồn trên PCB:} Hàn và kiểm tra MP2482 để
tạo bus 5V từ nguồn ắc quy xe (12V hoặc 24V). Lắp XL1509 3.3E cấp riêng
cho ESP32-S3, TPS54231 tạo rail \textasciitilde4V cho modem SIM7600CE-T,
SX1308 tạo 5V backup từ pin 18650 1S, diode OR giữa nhánh 5V chính và
nhánh 5V backup, cùng TP4056 kết nối với pin và BMS.

\textbf{Bước 3 - Lắp ráp khối xử lý và điều khiển:} Hàn
ESP32-S3-WROOM-1, LIS3DSH, LM393 và các linh kiện liên quan lên PCB
chính. Kiểm tra các chân GPIO theo bảng phân công (Bảng 4.1) và cấp
nguồn theo từng rail chức năng (3.3V logic, \textasciitilde4V modem, 5V
bus/backup).
...
\emph{Hình 4.12: Quy trình lắp ráp phần cứng trên PCB}

\begin{quote}
Nguồn: Hình dựng minh họa bởi tác giả, bám theo quy trình lắp ráp thực
tế
\end{quote}

\pandocbounded{\safeincludesvg{./assets/figures/07-chuong-4-trien-khai-hardware-hinh-4-13.svg}}

\emph{Hình 4.13: Sơ đồ bố trí linh kiện sau khi lắp ráp}

\begin{quote}
Nguồn: Hình dựng minh họa bởi tác giả, bám theo bố cục phần cứng đã chế
tạo
\end{quote}
...
\emph{Hình 4.14: Minh họa vị trí cổng OBD2 trên xe và cách kết nối}
...
\emph{Hình 4.15: Minh họa lắp đặt thiết bị tracker trong xe và đi dây}

\begin{quote}
Nguồn: Hình dựng minh họa bởi tác giả, bám theo phương án lắp đặt đề
xuất
\end{quote}
...
\emph{Hình 4.16: Checklist kiểm tra hệ thống sau khi lắp đặt trong xe}

\begin{quote}
Nguồn: Hình dựng minh họa bởi tác giả, bám theo quy trình kiểm tra sau
lắp đặt
\end{quote}
...
\textbf{Bảng 4.5: Công cụ phát triển firmware}
...
\textbf{Bảng 4.6: Kiến trúc phân tầng firmware}
...
1 & \texttt{adc\_reader}, \texttt{imu\_lis3dh}, \texttt{modem\_at},
\texttt{modem\_lte}, \texttt{modem\_gnss}, \texttt{ble\_mgr},
\texttt{ble\_obd} & Truy cập phần cứng và giao thức ngoại vi \\
2 & \texttt{power\_mgr}, \texttt{nvs\_config}, \texttt{app\_state} &
Quản lý nguồn, ngưỡng LVD, cấu hình lưu bền và ngữ cảnh qua deep
sleep \\
3 & \texttt{state\_machine}, \texttt{command\_handler} & Điều phối trạng
thái vận hành, lệnh điều khiển, OTA và rollback \\
...
\textbf{Bảng 4.7: Bảng ánh xạ chân GPIO}
...
\bottomrule\noalign{}
\endlastfoot
2 & IGN\_IN & Input & Đọc trạng thái khóa điện (hoặc qua OBD2) \\
4 & U\_BATT\_ADC & Input & Đọc điện áp ắc quy (ADC 12-bit) \\
5 & CHARGER\_EN & Output & Điều khiển IC sạc TP4056 \\
16 & MODEM\_UART\_TX & Output & UART TX đến modem SIM7600CE-T \\
17 & MODEM\_UART\_RX & Input & UART RX từ modem SIM7600CE-T \\
18 & POWER\_PATH\_EN & Output & Chọn nguồn cấp (ắc quy/pin dự phòng) \\
19 & LVD\_STATUS & Input & Trạng thái từ comparator LM393 \\
21 & LIS3DSH\_INT & Input & Ngắt từ cảm biến gia tốc IMU \\
47 & LIS3DSH\_SDA & I/O & I2C data line \\
48 & LIS3DSH\_SCL & I/O & I2C clock line \\
26 & MODEM\_PWR-KEY & Output & Điều khiển nguồn modem \\
\end{longtable}
}
...
\textbf{Bảng 4.8: Các PID OBD2 được đọc định kỳ (Mode 0x01 - Current
Data)}
...
\bottomrule\noalign{}
\endlastfoot
\texttt{v1/\{device\_id\}/rawdata} & Device -\textgreater{} Server &
Telemetry chính: GNSS, nguồn, rung \\
\texttt{v1/\{device\_id\}/events} & Device -\textgreater{} Server & Sự
kiện và cảnh báo quan trọng \\
\texttt{v1/\{device\_id\}/status} & Device -\textgreater{} Server &
Heartbeat và trạng thái phiên \\
\texttt{v1/\{device\_id\}/firmware} & Device -\textgreater{} Server &
Tiến trình OTA \\
\texttt{v1/\{device\_id\}/commands} & Server -\textgreater{} Device &
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-08-chuong-4-trien-khai-firmware-02.svg}}

\emph{Hình 4.16a: Chuỗi bước OTA trên firmware từ nhận lệnh đến xác nhận
sau reboot}

\begin{quote}
Nguồn: Hình dựng từ mã nguồn \texttt{command\_handler.c},
\texttt{state\_machine.c} và \texttt{util.c}
\end{quote}
...
\textbf{Bảng 4.9: So sánh các chế độ ngủ}
...
\bottomrule\noalign{}
\endlastfoot
Light sleep & \textasciitilde0.8 mA & \textless{} 1 ms & Giữ active &
IGN ON, đợi dữ liệu giữa các chu kỳ \\
Deep sleep & \textasciitilde10 µA & \textasciitilde100 ms & Mất kết nối
& IGN OFF, chế độ đỗ xe \\
\end{longtable}
}
...
\textbf{Bảng 4.10: Các trạng thái của firmware}
...
\bottomrule\noalign{}
\endlastfoot
INIT & \texttt{STATE\_INIT} & Khởi tạo hệ thống, ngoại vi \\
CHECK\_IGN & \texttt{STATE\_CHECK\_IGN} & Kiểm tra trạng thái khóa
điện \\
DRIVING & \texttt{STATE\_DRIVING} & Chế độ lái xe - theo dõi liên tục \\
PARKED & \texttt{STATE\_PARKED} & Chế độ đỗ xe - heartbeat định kỳ \\
ALARM & \texttt{STATE\_ALARM} & Chế độ cảnh báo - phát hiện chuyển
động \\
HEARTBEAT & \texttt{STATE\_HEARTBEAT} & Gửi tín hiệu heartbeat \\
SLEEP & \texttt{STATE\_SLEEP} & Deep sleep tiết kiệm năng lượng \\
\end{longtable}
}

\textbf{Bảng 4.11: Chuyển đổi trạng thái}
...
SLEEP & Timer hoặc IMU wake-up & CHECK\_IGN \\
\end{longtable}
}
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-08-chuong-4-trien-khai-firmware-01.svg}}

\emph{Hình 4.17: Lưu đồ thuật toán chính của firmware thiết bị theo dõi
xe}
...
\emph{Hình 4.18: Kiến trúc tổng thể hệ thống Cloud và luồng dữ liệu}
...
\emph{Hình 4.19: Cấu trúc thư mục hệ thống theo quy ước IVM26}
...
VictoriaLogs (port 9428), và Grafana (port 4001). Các dịch vụ đều chia
...
\BuiltInTok{cd}\NormalTok{ Tracking\_PostgreSQL }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ Tracking\_EMQX }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ Tracking\_VictoriaMetrics }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ Tracking\_VictoriaLogs }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ Tracking\_Grafana }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}

\CommentTok{\# Bước 2: Khởi động dịch vụ ứng dụng}
\BuiltInTok{cd}\NormalTok{ Tracking\_MqttBridge }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d} \AttributeTok{{-}{-}build}
\BuiltInTok{cd}\NormalTok{ Tracking\_Backend }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d} \AttributeTok{{-}{-}build}
\BuiltInTok{cd}\NormalTok{ Tracking\_Frontend }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d} \AttributeTok{{-}{-}build}
\end{Highlighting}
\end{Shaded}
...
\emph{Hình 4.20: Luồng xử lý dữ liệu của MQTT Bridge}
...
\emph{Hình 4.21: Cấu trúc thư mục Backend theo kiến trúc DDD}
...
\bottomrule\noalign{}
\endlastfoot
Authentication & \texttt{/api/v1/auth} & Không (login) / Có & Đăng nhập,
đăng xuất, quản lý người dùng \\
Devices & \texttt{/api/v1/devices} & Có & CRUD thiết bị, sessions,
runtime, lệnh \\
IoT Data & \texttt{/api/v1/iot} & Không (public) & Nhận dữ liệu từ thiết
bị IoT \\
Dashboard & \texttt{/api/v1/dashboard} & Có & Thống kê, hoạt động gần
đây, cảnh báo \\
Vehicles & \texttt{/api/v1/vehicles} & Có & CRUD xe, gán thiết bị \\
Customers & \texttt{/api/v1/customers} & Có & CRUD khách hàng \\
Trips & \texttt{/api/v1/trips} & Có & CRUD chuyến đi, lịch sử \\
Alerts & \texttt{/api/v1/alerts} & Có & Quản lý cảnh báo \\
Geofences & \texttt{/api/v1/geofences} & Có & CRUD vùng địa lý \\
Firmware & \texttt{/api/v1/firmware} & Có (admin) & OTA firmware
management \\
\end{longtable}
}
...
\emph{Hình 4.22: Cấu trúc thư mục Frontend theo kiến trúc
Feature-Sliced}
...
\emph{Hình 4.23: Giao diện trang Dashboard tổng quan}
...
\emph{Hình 4.24: Giao diện trang quản lý xe}
...
\emph{Hình 4.25: Giao diện bản đồ thời gian thực với vị trí các xe}
...
\emph{Hình 4.26: Giao diện trang quản lý cảnh báo}
...
layout, auth, API client, React Query & Hoàn thành \\
...
reports, reviews & Chưa triển khai \\
\end{longtable}
}
...
\KeywordTok{ENV}\NormalTok{ PORT=4002}
...
\KeywordTok{EXPOSE}\NormalTok{ 4002}
\KeywordTok{HEALTHCHECK} \OperatorTok{{-}{-}interval=30s} \OperatorTok{{-}{-}timeout=5s} \OperatorTok{{-}{-}start{-}period=15s} \OperatorTok{{-}{-}retries=3}\NormalTok{ \textbackslash{}}
  \KeywordTok{CMD} \FunctionTok{wget} \AttributeTok{{-}{-}spider}\NormalTok{ http://127.0.0.1:4002 }\KeywordTok{||} \BuiltInTok{exit}\NormalTok{ 1}
\KeywordTok{CMD}\NormalTok{ [}\StringTok{"node"}\NormalTok{, }\StringTok{"server.js"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}

Dockerfile sử dụng 3 giai đoạn: \texttt{deps} (cài đặt dependencies),
\texttt{builder} (build ứng dụng), và \texttt{runner} (chạy production).
Giai đoạn \texttt{runner} chỉ sao chép các file cần thiết từ giai đoạn
...
logs, error logs, MQTT events, device events \\
Traces & Request-ID Correlation & Truy vết request xuyên suốt hệ thống &
Request-ID (UUID v4) trên mỗi request \\
...
\emph{Hình 4.27: Grafana dashboard hiển thị tổng quan hiệu năng hệ
thống}
...
\emph{Hình 4.28: EMQX Dashboard hiển thị trạng thái kết nối thiết bị}
...
cho telemetry/log & Cao & Phục hồi được dữ liệu theo RPO/RTO đã định \\
...
µA-10A & Đo dòng tiêu thụ các chế độ \\
2 & Nguồn cấp DC & UNI-T UTP1306S & 0--32V / 0--6A, độ phân giải
10mV/1mA & Mô phỏng ắc quy xe 12V hoặc 24V \\
3 & Oscilloscope & Rigol DS1054Z & 50 MHz, 4 kênh & Phân tích tín hiệu,
đo thời gian chuyển trạng thái \\
...
\emph{Hình 4.29: Bố trí thiết bị đo lường trong phòng thí nghiệm}
...
\emph{Hình 4.30: Thiết bị tracker được lắp đặt trên xe thử nghiệm}
...
\emph{Hình 4.31: Sơ đồ môi trường thử nghiệm tổng thể}
...
{[}Bảng 4.14: Kết quả đo dòng tiêu thụ năng lượng theo chế độ hoạt
động{]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Chế độ hoạt động & Mô tả & Dòng trung bình & Dòng đỉnh (peak) &
Ghi chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\textasciitilde350 mA & \textasciitilde520 mA & Peak khi truyền dữ liệu
4G \\
2 & Active - Idle (chờ dữ liệu) & 4G kết nối + MCU active &
\textasciitilde180 mA & \textasciitilde280 mA & Giữa các chu kỳ gửi dữ
liệu \\
3 & Sleep Mode (IGN OFF) & MCU light sleep + 4G off & \textasciitilde15
mA & \textasciitilde25 mA & Heartbeat mỗi 10--30 phút \\
4 & Deep Sleep Mode & MCU deep sleep + IMU wake & \textasciitilde0.5 mA
& \textasciitilde2 mA (ước tính, cần xác nhận thêm) & Chỉ IMU + RTC hoạt
động \\
5 & Alert Mode (bất thường) & Đánh thức từ deep sleep &
\textasciitilde380 mA & \textasciitilde550 mA & Tương tự Active + GPS
cold start \\
\end{longtable}
}
...
\emph{Hình 4.32: Đồ thị dòng tiêu thụ theo thời gian trong một chu kỳ
hoạt động hoàn chỉnh (Driving -\textgreater{} Parking -\textgreater{}
Alert -\textgreater{} Parking)}
...
\tightlist
\item
  Dòng tiêu thụ trong chế độ Active (\textasciitilde350 mA) phù hợp với
...
\item
  Dòng tiêu thụ trong chế độ Deep Sleep (\textasciitilde0.5 mA) nằm sát
...
\item
  Dòng peak khi truyền dữ liệu 4G (\textasciitilde520 mA) cần được lưu ý
...
mạch boost converter (\textasciitilde85--90\%). Các giá trị dưới đây là
\textbf{ước tính theo baseline 18650}, không phải bộ số đo thực nghiệm
mới trên cell 18650.

{[}Bảng 4.15: Thời lượng pin dự phòng theo kịch bản sử dụng (ước tính
theo baseline 18650){]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Kịch bản sử dụng & Dòng trung bình & Thời lượng ước tính & Trạng
thái dữ liệu & Ghi chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & Tracking liên tục (Active) & \textasciitilde350 mA &
\textasciitilde2.6--3.0 giờ & Quy đổi theo baseline 18650 & Trường hợp
xấu nhất, phụ thuộc hiệu suất boost \\
2 & Sleep + heartbeat 30 phút & \textasciitilde15 mA & \textasciitilde64
giờ & Quy đổi theo baseline 18650 & Xe đậu bình thường \\
3 & Deep Sleep (IMU watch) & \textasciitilde0.5 mA &
\textasciitilde1,940 giờ (\textasciitilde81 ngày) & Quy đổi theo
baseline 18650 & Chế độ tiết kiệm tối đa \\
4 & Hỗn hợp (50\% Active + 50\% Sleep) & \textasciitilde182 mA &
\textasciitilde5.0 giờ & Quy đổi theo baseline 18650 & Mô phỏng sử dụng
thực tế \\
\end{longtable}
}
...
\emph{Hình 4.33: Đồ thị điện áp pin dự phòng theo thời gian theo
baseline 18650 trong kịch bản tracking liên tục}
...
\toprule\noalign{}
STT & Nhiệt độ thử nghiệm & Trạng thái hoạt động & GPS fix & 4G kết nối
& OBD2 BLE & Ghi chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
không ổn định, cần kiểm tra lặp lại \\
...
\emph{Hình 4.34: Đồ thị dòng tiêu thụ theo nhiệt độ môi trường}
...
{[}Bảng 4.17: Kết quả kiểm thử tương thích OBD2 trên các thương hiệu
xe{]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}lllllllll@{}}
\toprule\noalign{}
STT & Xe thử nghiệm & Năm sản xuất & Giao thức OBD2 & Kết nối BLE & Đọc
RPM & Đọc Speed & Đọc Coolant Temp & Ghi chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
...
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Thông số & Giá trị thiết kế & Giá trị đo & Sai lệch & Trạng
thái \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
11.48V {[}đo theo profile 12V{]} & 4.33\% & Chưa đạt (12V) \\
2 & Điện áp đóng lại (reconnect) & Profile 12V: 12.2V; Profile 24V:
24.4V & 12.53V {[}đo theo profile 12V, cần tinh chỉnh về 12.2V{]} &
2.70\% & Chưa đạt (12V) \\
3 & Độ trễ ngắt & \textless{} 100 ms & \textasciitilde50 ms (đo bước
đầu) & --- & Đạt \\
4 & Độ trễ đóng lại & \textless{} 500 ms & \textasciitilde200 ms (đo
bước đầu) & --- & Đạt \\
...
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Thông số & Giá trị trung bình & Giá trị min & Giá trị max & Độ
lệch chuẩn \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & Thời gian scan BLE & \textasciitilde1.5 giây & 0.8 giây & 3.2 giây &
0.6 giây \\
2 & Thời gian kết nối BLE & \textasciitilde1.0 giây & 0.5 giây & 2.1
giây & 0.4 giây \\
3 & Thời gian khởi tạo ELM327 & \textasciitilde1.5 giây & 1.0 giây & 2.5
giây & 0.3 giây \\
4 & \textbf{Tổng thời gian (scan + connect + init)} &
\textbf{\textasciitilde4.0 giây} & \textbf{2.3 giây} & \textbf{7.8 giây}
& \textbf{1.3 giây} \\
\end{longtable}
}
...
\emph{Hình 4.35: Biểu đồ phân bố thời gian kết nối BLE OBD2 (20 lần đo)}
...
\textasciitilde4 giây (scan \textasciitilde1.5s + connect
\textasciitilde1.0s + init \textasciitilde1.5s), nằm trong phạm vi mục
...
\bottomrule\noalign{}
\endlastfoot
1 & 0x0C & RPM động cơ & \textasciitilde65 ms & 40 ms & 120 ms \\
2 & 0x0D & Tốc độ xe (km/h) & \textasciitilde60 ms & 38 ms & 110 ms \\
3 & 0x05 & Nhiệt độ nước làm mát & \textasciitilde70 ms & 45 ms & 130
ms \\
4 & 0x2F & Mức nhiên liệu (\%) & \textasciitilde75 ms & 50 ms & 140
ms \\
5 & 0x04 & Tải động cơ (\%) & \textasciitilde68 ms & 42 ms & 125 ms \\
6 & 0x11 & Vị trí bướm ga (\%) & \textasciitilde62 ms & 39 ms & 115
ms \\
\end{longtable}
}

\textbf{Nhận xét:} Thời gian phản hồi trung bình cho mỗi PID đạt
\textasciitilde60--75 ms, nằm trong mục tiêu thiết kế
(\textasciitilde50--100 ms). Với 6 PID được đọc trong mỗi chu kỳ, tổng
...
\begin{longtable}[]{@{}lllllll@{}}
\toprule\noalign{}
STT & Kịch bản & Mô tả & TTFF trung bình & Min & Max & Số vệ tinh trung
bình \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & Cold Start & Không có dữ liệu vệ tinh cũ & \textasciitilde30 giây &
20 giây & 60 giây & 6--8 \\
2 & Warm Start & Có dữ liệu ephemeris còn hiệu lực & \textasciitilde5
giây & 3 giây & 12 giây & 8--10 \\
3 & Hot Start & Module GNSS đã hoạt động, tạm mất tín hiệu &
\textasciitilde1 giây & 0.5 giây & 3 giây & 10--12 \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-27.svg}}

\emph{Hình 4.36: Đồ thị thời gian bắt vệ tinh GPS trong các kịch bản
(Cold/Warm/Hot Start)}
...
\bottomrule\noalign{}
\endlastfoot
1 & Ngoài trời, trời quang & \textasciitilde2.3 mét & \textasciitilde4.5
mét & \textasciitilde3.8 mét \\
2 & Ngoài trời, trời u ám & \textasciitilde3.5 mét & \textasciitilde7.2
mét & \textasciitilde5.5 mét \\
3 & Trong phố (urban canyon) & \textasciitilde5.8 mét &
\textasciitilde15 mét (cần xác nhận thêm) & \textasciitilde10 mét (cần
xác nhận thêm) \\
4 & Bãi đỗ xe có mái che & \textasciitilde8.5 mét (ước tính ban đầu) &
\textasciitilde20 mét (cần xác nhận thêm) & \textasciitilde15 mét (cần
xác nhận thêm) \\
\end{longtable}
}

\textbf{Nhận xét:} Độ chính xác vị trí GPS đạt \textasciitilde2--3 mét
...
\bottomrule\noalign{}
\endlastfoot
1 & 4G ổn định (\textgreater= 3 thanh) & QoS 0 & \textasciitilde120 ms &
60 ms & 350 ms & \textasciitilde250 ms \\
2 & 4G ổn định (\textgreater= 3 thanh) & QoS 1 & \textasciitilde180 ms &
80 ms & 500 ms & \textasciitilde380 ms \\
3 & 4G yếu (1--2 thanh) & QoS 0 & \textasciitilde350 ms & 120 ms & 1200
ms & \textasciitilde800 ms \\
4 & 4G yếu (1--2 thanh) & QoS 1 & \textasciitilde500 ms & 150 ms & 2000
ms & \textasciitilde1500 ms \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-28.svg}}

\emph{Hình 4.37: Biểu đồ phân bố độ trễ MQTT trong điều kiện mạng 4G ổn
định}
...
\textbf{Nhận xét:} Độ trễ MQTT trung bình \textasciitilde120--180 ms
trong điều kiện mạng 4G ổn định, đạt mục tiêu thiết kế
(\textasciitilde100--300 ms). QoS 1 có độ trễ cao hơn QoS 0 khoảng 50\%
...
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Chuyển đổi trạng thái & Số lần thử nghiệm & Thành công & Thất bại
& Tỷ lệ thành công \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
100\% \\
5 & Alert -\textgreater{} Driving (IGN ON) & 500 & 500 & 0 & 100\% \\
6 & Mất nguồn -\textgreater{} Pin dự phòng & 200 & 200 & 0 & 100\% \\
\end{longtable}
}
...
\textasciitilde10 giây & Đạt \\
2 & Thời gian tự động kết nối lại & \textless= 30 giây &
\textasciitilde15--30 giây & Đạt \\
...
\toprule\noalign{}
STT & Endpoint & Method & Thời gian trung bình & P50 & P95 & P99 &
Throughput (req/s) \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & GET /api/v1/vehicles & GET & \textasciitilde45 ms & 38 ms & 95 ms &
150 ms & \textasciitilde850 \\
2 & GET /api/v1/vehicles/:id & GET & \textasciitilde35 ms & 28 ms & 72
ms & 120 ms & \textasciitilde1100 \\
3 & POST /api/v1/vehicles & POST & \textasciitilde65 ms & 55 ms & 130 ms
& 200 ms & \textasciitilde600 \\
4 & GET /api/v1/devices/:id/telemetry & GET & \textasciitilde55 ms & 45
ms & 110 ms & 180 ms & \textasciitilde750 \\
5 & GET /api/v1/trips & GET & \textasciitilde80 ms & 65 ms & 160 ms &
250 ms & \textasciitilde500 \\
6 & GET /api/v1/alerts & GET & \textasciitilde50 ms & 42 ms & 100 ms &
165 ms & \textasciitilde800 \\
7 & POST /api/v1/auth/login & POST & \textasciitilde120 ms & 100 ms &
200 ms & 350 ms & \textasciitilde350 \\
8 & GET /api/v1/geofences & GET & \textasciitilde40 ms & 32 ms & 85 ms &
140 ms & \textasciitilde900 \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-29.svg}}

\emph{Hình 4.38: Biểu đồ thời gian phản hồi API (P50, P95, P99) cho các
endpoint chính}
...
\textasciitilde35--120 ms cho các thao tác CRUD, đạt mục tiêu thiết kế
(\textless{} 200 ms cho P95). Endpoint POST /api/auth/login có thời gian
cao hơn (\textasciitilde120 ms) do quá trình hash và xác thực password.
...
{[}Bảng 4.27: Độ trễ end-to-end (Device -\textgreater{} Cloud
-\textgreater{} Browser){]}
...
\bottomrule\noalign{}
\endlastfoot
1 & Device -\textgreater{} EMQX (MQTT publish) & \textasciitilde150 ms &
\textasciitilde300 ms & Qua mạng 4G \\
2 & EMQX -\textgreater{} MQTT Bridge (subscribe) & \textasciitilde5 ms &
\textasciitilde15 ms & Nội bộ Docker network \\
3 & Bridge -\textgreater{} VictoriaMetrics (write) & \textasciitilde10
ms & \textasciitilde30 ms & HTTP write API \\
4 & Bridge -\textgreater{} Backend (internal event) & \textasciitilde5
ms & \textasciitilde12 ms & Internal HTTP/event \\
5 & Backend -\textgreater{} Frontend (WebSocket) & \textasciitilde15 ms
& \textasciitilde40 ms & Socket.IO emit \\
6 & \textbf{Tổng end-to-end} & \textbf{\textasciitilde185 ms} &
\textbf{\textasciitilde400 ms} & \textbf{Device đến Dashboard} \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-30.svg}}

\emph{Hình 4.39: Đồ thị phân bố độ trễ end-to-end (1000 bản tin mẫu)}

\begin{quote}
Nguồn: Hình dựng từ dữ liệu đo và kịch bản thử nghiệm của tác giả
\end{quote}

\textbf{Nhận xét:} Độ trễ end-to-end trung bình \textasciitilde185 ms
(P95 \textasciitilde400 ms), thấp hơn nhiều so với mục tiêu thiết kế
(\textless{} 3 giây). Phần lớn độ trễ tập trung ở đoạn truyền dữ liệu từ
thiết bị lên EMQX qua mạng 4G (\textasciitilde150 ms). Các đoạn xử lý
nội bộ (EMQX -\textgreater{} Bridge -\textgreater{} Backend
-\textgreater{} Frontend) có độ trễ rất thấp (\textasciitilde35 ms
...
\begin{longtable}[]{@{}lllllll@{}}
\toprule\noalign{}
STT & Hệ thống & Loại dữ liệu & Thông lượng trung bình & Thông lượng tối
đa & CPU Usage & RAM Usage \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & VictoriaMetrics & Time-series (telemetry) & \textasciitilde12,000
điểm/giây & \textasciitilde25,000 điểm/giây & \textasciitilde15\% &
\textasciitilde200 MB \\
2 & PostgreSQL & Relational (alerts, trips) & \textasciitilde3,000
row/giây & \textasciitilde8,000 row/giây & \textasciitilde25\% &
\textasciitilde300 MB \\
3 & VictoriaLogs & Event logs & \textasciitilde5,000 dòng/giây &
\textasciitilde15,000 dòng/giây & \textasciitilde8\% &
\textasciitilde150 MB \\
\end{longtable}
}

\textbf{Nhận xét:} VictoriaMetrics đạt thông lượng ghi
\textasciitilde12,000 điểm/giây, đủ để xử lý dữ liệu từ hàng trăm thiết
bị (mỗi thiết bị gửi \textasciitilde10--20 điểm dữ liệu mỗi 5 giây,
tương đương \textasciitilde2--4 điểm/giây/thiết bị). Với mục tiêu
50--100 thiết bị, tổng tải ghi chỉ khoảng 200--400 điểm/giây, chỉ chiếm
\textasciitilde3\% công suất của VictoriaMetrics. PostgreSQL đạt thông
lượng ghi \textasciitilde3,000 row/giây, đủ cho các thao tác quan hệ
...
\begin{longtable}[]{@{}llllllll@{}}
\toprule\noalign{}
STT & Số thiết bị mô phỏng & Tần suất gửi (giây) & MQTT Message/s & CPU
Server & RAM Server & Mất bản tin & Độ trễ trung bình \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & 10 & 5 & \textasciitilde20 msg/s & \textasciitilde5\% &
\textasciitilde1.2 GB & 0\% & \textasciitilde150 ms \\
2 & 25 & 5 & \textasciitilde50 msg/s & \textasciitilde10\% &
\textasciitilde1.5 GB & 0\% & \textasciitilde160 ms \\
3 & 50 & 5 & \textasciitilde100 msg/s & \textasciitilde18\% &
\textasciitilde1.8 GB & 0\% & \textasciitilde180 ms \\
4 & 100 & 5 & \textasciitilde200 msg/s & \textasciitilde30\% &
\textasciitilde2.5 GB & 0\% & \textasciitilde220 ms \\
5 & 200 & 5 & \textasciitilde400 msg/s & \textasciitilde55\% &
\textasciitilde3.5 GB & 0.1\% (ước tính ở tải biên) & \textasciitilde350
ms (ước tính ở tải biên) \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-31.svg}}

\emph{Hình 4.40: Đồ thị hiệu suất hệ thống theo số lượng thiết bị đồng
thời}
...
(CPU \textasciitilde30\%, RAM \textasciitilde2.5 GB). Điểm giới hạn ước
tính \textasciitilde200 thiết bị trên cấu hình server hiện tại (4 vCPU,
...
\bottomrule\noalign{}
\endlastfoot
1 & Lighthouse Performance Score & 87/100 (đo trên bản dựng thử nghiệm)
& \textgreater{} 85 & Đạt \\
2 & First Contentful Paint (FCP) & \textasciitilde1.2 giây (đo trên bản
dựng thử nghiệm) & \textless{} 1.5 giây & Đạt \\
3 & Largest Contentful Paint (LCP) & \textasciitilde2.1 giây (đo trên
bản dựng thử nghiệm) & \textless{} 2.5 giây & Đạt \\
4 & Total Blocking Time (TBT) & \textasciitilde120 ms (đo trên bản dựng
thử nghiệm) & \textless{} 200 ms & Đạt \\
5 & Cumulative Layout Shift (CLS) & \textasciitilde0.05 (đo trên bản
dựng thử nghiệm) & \textless{} 0.1 & Đạt \\
6 & Time to Interactive (TTI) & \textasciitilde2.5 giây (đo trên bản
dựng thử nghiệm) & \textless{} 3.5 giây & Đạt \\
7 & Bundle Size (gzipped) & \textasciitilde380 KB (đo trên bản dựng thử
nghiệm) & \textless{} 500 KB & Đạt \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-32.svg}}

\emph{Hình 4.41: Kết quả Lighthouse Performance Audit của trang
Dashboard}
...
\textasciitilde87/100, vượt mục tiêu thiết kế (\textgreater{} 85). First
Contentful Paint \textasciitilde1.2 giây cho trải nghiệm tải trang
...
công & \textasciitilde2 giây từ deep sleep \\
2 & BLE OBD2 connect & Quét và kết nối vgate iCar Pro & Thành công &
\textasciitilde4 giây \\
3 & GPS fix & Module GNSS bắt vệ tinh & Thành công & \textasciitilde5
giây (warm start) \\
4 & OBD2 data read & Đọc RPM, Speed, Coolant Temp, Fuel Level & Thành
công & \textasciitilde0.5 giây \\
5 & MQTT publish & Gửi bản tin telemetry lên EMQX & Thành công &
\textasciitilde0.15 giây \\
6 & Bridge process & MQTT Bridge nhận và xử lý bản tin & Thành công &
\textasciitilde0.01 giây \\
7 & DB write & Ghi VictoriaMetrics + PostgreSQL & Thành công &
\textasciitilde0.02 giây \\
8 & WebSocket push & Backend phát sự kiện đến Frontend & Thành công &
\textasciitilde0.02 giây \\
9 & Dashboard update & Bản đồ và biểu đồ cập nhật & Thành công &
\textasciitilde0.05 giây \\
& \textbf{Tổng thời gian end-to-end} & \textbf{Từ dữ liệu cảm biến đến
hiển thị} & \textbf{Thành công} & \textbf{\textasciitilde1--2 giây} \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-33.svg}}

\emph{Hình 4.42: Screenshot giao diện Dashboard hiển thị vị trí xe đang
di chuyển trên bản đồ (Leaflet)}
...
\emph{Hình 4.43: Screenshot biểu đồ dữ liệu OBD2 thời gian thực
(ECharts) --- RPM, Speed, Coolant Temp}
...
\textasciitilde2 giây & Cập nhật khi nhận GPS mới \\
2 & Xe đi ra khỏi vùng geofence & Cảnh báo "GEOFENCE\_EXIT" &
\textasciitilde5 giây & Phụ thuộc chu kỳ gửi GPS \\
3 & Cảnh báo hiển thị trên Dashboard & Popup notification xuất hiện &
\textasciitilde1 giây (từ lúc alert tạo) & Qua WebSocket \\
4 & Xe quay lại vùng geofence & Hiển thị trạng thái "INSIDE", cảnh báo
tự động đóng & \textasciitilde3 giây & Reset tự động \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-35.svg}}

\emph{Hình 4.44: Screenshot cảnh báo Geofence trên giao diện Dashboard
với bản đồ hiển thị vùng cảnh báo}
...
trong vòng \textasciitilde5 giây (phụ thuộc chu kỳ gửi GPS, mặc định 5
giây). Cảnh báo được hiển thị trên Dashboard trong vòng \textasciitilde1
...
\bottomrule\noalign{}
\endlastfoot
1 & request\_location & Yêu cầu vị trí hiện tại & Thành công &
\textasciitilde3 giây \\
2 & update\_config & Cập nhật tần suất gửi dữ liệu & Thành công &
\textasciitilde2 giây \\
3 & restart\_device & Khởi động lại thiết bị & Thành công &
\textasciitilde15 giây (bao gồm thời gian restart) \\
4 & enable\_alert\_mode & Bật chế độ cảnh báo & Thành công &
\textasciitilde2 giây \\
\end{longtable}
}
...
\emph{Hình 4.45: Screenshot giao diện gửi lệnh điều khiển từ Dashboard
và kết quả phản hồi từ thiết bị}
...
cục bộ + gửi chu kỳ mới & Giảm khoảng trống dữ liệu outage \\
...
gian outage/queue depth \\
\end{longtable}
}

\pandocbounded{\safeincludesvg{./assets/figures/10-chuong-4-ket-qua-do-luong-hinh-4-37.svg}}

\emph{Hình 4.46: Screenshot hành trình trên bản đồ, thể hiện giai đoạn
gián đoạn và tiếp tục cập nhật sau khi phục hồi kết nối}
...
{[}Bảng 4.35: Tổng hợp kết quả đo lường phần cứng so với chỉ tiêu thiết
kế{]}

{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}llllll@{}}
\toprule\noalign{}
STT & Tiêu chí & Chỉ tiêu thiết kế & Kết quả đạt được & Trạng thái & Ghi
chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
1 & Dòng tiêu thụ Deep Sleep & \textless{} 500 µA & \textasciitilde500
µA (\textasciitilde0.5 mA) & Đạt & IMU + RTC hoạt động \\
2 & Dòng tiêu thụ Active Mode & \textless{} 250 mA (trung bình) &
\textasciitilde180--220 mA (TB); \textasciitilde350 mA khi truyền liên
tục & Đạt ở mức trung bình & Xem ghi chú (*) \\
3 & Thời lượng pin dự phòng (tracking) & \textgreater= 2.5 giờ &
\textasciitilde2.6--3.0 giờ (quy đổi theo baseline 18650) & Đạt theo quy
đổi & Cần đo lại trên mẫu pin 18650 \\
4 & Nhiệt độ hoạt động & -10°C đến +60°C & -10°C đến +60°C & Đạt &
Module 4G hạn chế ở 70°C \\
5 & Điện áp ngắt LVD & Profile 12V: 12.0V; Profile 24V: 24.0V &
\textasciitilde11.48V (đo theo profile 12V) & Chưa đạt (12V) & Profile
24V chưa đo thực nghiệm \\
6 & Thời gian thức dậy từ deep sleep & \textless{} 3 giây &
\textasciitilde2 giây & Đạt & Bao gồm init cơ bản \\
7 & Độ chính xác GPS & \textless{} 5 mét & \textasciitilde2--3 mét
(ngoài trời) & Đạt & GNSS đa hệ thống \\
\end{longtable}
}
...
{[}Bảng 4.36: Tổng hợp kết quả đo lường firmware so với chỉ tiêu thiết
kế{]}
...
\bottomrule\noalign{}
\endlastfoot
1 & Thời gian kết nối OBD2 BLE & \textless{} 10 giây & \textasciitilde4
giây (trung bình) & Đạt & Scan + Connect + Init \\
2 & Thời gian phản hồi OBD2 PID & \textasciitilde50--100 ms &
\textasciitilde60--75 ms & Đạt & 6 PID/chu kỳ \\
3 & GPS TTFF (Cold Start) & \textless{} 60 giây & \textasciitilde30 giây
& Đạt & GNSS đa hệ thống \\
4 & GPS TTFF (Warm Start) & \textless{} 15 giây & \textasciitilde5 giây
& Đạt & Có dữ liệu ephemeris \\
5 & Độ trễ MQTT (4G ổn định) & \textless{} 500 ms &
\textasciitilde120--180 ms & Đạt & QoS 0/1 \\
6 & Khả năng reconnect MQTT & Tự động, \textless{} 30 giây &
\textasciitilde15--30 giây & Đạt & Đã kết hợp replay cục bộ microSD theo
ACK/QoS \\
7 & Độ tin cậy state machine & \textgreater= 99.5\% & \textgreater=
99.8\% & Đạt & 1000+ chu kỳ \\
8 & Tần suất gửi GPS (driving) & 5--30 giây (cấu hình) & 5 giây (mặc
định) & Đạt & Cấu hình từ xa \\
\end{longtable}
}
...
{[}Bảng 4.37: Tổng hợp kết quả đo lường Cloud/Backend so với chỉ tiêu
thiết kế{]}
...
\textasciitilde95--200 ms & Đạt & Tùy endpoint \\
2 & Độ trễ end-to-end & \textless{} 3 giây & \textasciitilde1--2 giây &
Đạt & Device đến Dashboard \\
3 & Số thiết bị đồng thời & \textgreater= 50 & 50+ (tested) & Đạt & Ổn
định đến 100 \\
4 & Thông lượng ghi VictoriaMetrics & \textgreater= 1,000 điểm/giây &
\textasciitilde12,000 điểm/giây & Đạt & 12x mục tiêu \\
5 & Mất bản tin MQTT & 0\% (50 devices) & 0\% & Đạt & QoS 1 cho
alerts \\
6 & WebSocket latency & \textless{} 500 ms & \textasciitilde35 ms
(internal) & Đạt & Rất nhanh (nội bộ) \\
\end{longtable}
}
...
{[}Bảng 4.38: Tổng hợp kết quả đo lường Frontend so với chỉ tiêu thiết
kế{]}
...
\bottomrule\noalign{}
\endlastfoot
1 & Lighthouse Performance & \textgreater{} 85 & \textasciitilde87 (đo
trên desktop) & Đạt & Desktop mode \\
2 & First Contentful Paint & \textless{} 1.5 giây & \textasciitilde1.2
giây (đo trên desktop) & Đạt & Next.js SSR \\
3 & Cập nhật bản đồ thời gian thực & \textless{} 2 giây &
\textasciitilde1--2 giây & Đạt & WebSocket + Leaflet \\
4 & Cảnh báo thời gian thực & \textless{} 5 giây & \textasciitilde1 giây
(từ lúc tạo alert) & Đạt & Socket.IO event \\
...
{[}Bảng 4.39: Bảng tổng hợp tổng thể --- So sánh kết quả với chỉ tiêu
thiết kế{]}
...
\bottomrule\noalign{}
\endlastfoot
1 & Độ chính xác GPS & \textless{} 5 mét & \textasciitilde2--3 mét (GNSS
tích hợp SIM7600CE-T) & Đạt \\
2 & Chu kỳ cập nhật dữ liệu & \textless= 10 giây & 5 giây (cấu hình
được) & Đạt \\
3 & Thời lượng pin dự phòng & \textgreater= 2.5 giờ &
\textasciitilde2.6--3.0 giờ (quy đổi theo baseline 18650) & Đạt theo quy
đổi \\
4 & Độ trễ end-to-end & \textless{} 3 giây & \textasciitilde1--2 giây &
Đạt \\
5 & Số phương tiện đồng thời & \textgreater= 50 & 50+ (tested) & Đạt \\
6 & Thời gian tải Dashboard & \textless{} 3 giây & \textasciitilde1.5
giây & Đạt \\
7 & Phát hiện geofence & \textless{} 10 giây & \textasciitilde5--7 giây
& Đạt \\
8 & Cảnh báo bất thường & \textless{} 10 giây & \textasciitilde5 giây
(IMU -\textgreater{} Dashboard) & Đạt \\
9 & Khôi phục kết nối MQTT & Tự động sau mất sóng & Reconnect ổn định,
tiếp tục gửi telemetry & Đạt \\
...
\emph{Hình 4.47: Biểu đồ radar so sánh chỉ tiêu thiết kế và kết quả đạt
được (spider chart)}
...
{[}1{]} SIMCom Wireless Solutions, "SIM7600CE Product Page," 2026.
{[}Online{]}. Available:
\url{https://en.simcom.com/product/SIM7600CE.html}. {[}Accessed: Mar.
13, 2026{]}.

{[}2{]} SAE International, "SAE J1979 - E/E Diagnostic Test Modes,"
Revised 2014. Tiêu chuẩn OBD-II áp dụng cho các xe sản xuất từ năm 2008
trở đi.

{[}3{]} European GNSS Agency (GSA), "GNSS Market Report - Issue 6,"
2022. Phân tích độ chính xác của các hệ thống GNSS đa tần số.

{[}4{]} OASIS, "MQTT Version 5.0 - OASIS Standard," Section 4.3 -
Quality of Service Levels, 2019.

{[}5{]} Google, "Web Vitals - Essential Metrics for a Healthy Site,"
\url{https://web.dev/vitals/}, 2024.

{[}6{]} Grafana Labs, "k6 Documentation - Load Testing Tool,"
\url{https://k6.io/docs/}, 2024.

{[}7{]} Espressif Systems, "ESP32-S3 Technical Reference Manual - Power
Management," Version 1.1, Chapter 31, 2023.

{[}8{]} VictoriaMetrics, "VictoriaMetrics Benchmarks - Write
Performance,"
\url{https://docs.victoriametrics.com/articles/benchmarks.html}, 2024.

\chapterheading{CHƯƠNG 5. ĐÁNH GIÁ VÀ KHUYẾN NGHỊ -- EVALUATION AND RECOMMENDATION}
...
\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
Tiêu chí & Giá trị thiết kế & Giá trị hiện có / quy đổi theo baseline
18650 & Đánh giá \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
Dòng tiêu thụ deep sleep & \textless{} 500 μA & \textasciitilde500 μA
(\textasciitilde0.5 mA) trên thiết bị hiện tại & Đạt yêu cầu \\
Dòng tiêu thụ driving mode & \textless{} 250 mA (trung bình) &
\textasciitilde180--220 mA trung bình; \textasciitilde350 mA khi truyền
liên tục & Đạt trung bình \\
Thời gian hoạt động pin dự phòng (alert mode) & \textgreater= 24 giờ
(mục tiêu baseline 18650) & \textasciitilde24--36 giờ (quy đổi theo
baseline 18650, cần đo lại) & Đạt theo quy đổi tối thiểu \\
Hiệu suất buck converter & \textgreater{} 85\% & 90--93\% & Tốt \\
Ngưỡng LVD & Profile 12V: 12.0V; Profile 24V: 24.0V &
\textasciitilde11.48V trên profile 12V; profile 24V chưa đo & Cần hiệu
chuẩn thêm \\
Thời gian chuyển chế độ (parking -\textgreater{} alert) & \textless{}
500 ms & 200--400 ms & Tốt \\
\end{longtable}
}
...
nhận được cho ứng dụng tracking xe. Sai số vị trí trung bình khoảng
...
giản & \texttt{app\_main} + \texttt{state\_machine\_run}; NimBLE chạy
task nền riêng & Phù hợp mã nguồn \\
Thời gian chuyển trạng thái & \textless{} 500 ms & 200--400 ms & Tốt \\
Thời gian reconnect MQTT & \textless{} 30 giây & \textasciitilde15--30
giây & Đạt yêu cầu \\
Tỷ lệ gửi thành công MQTT (QoS 1) & \textgreater{} 99\% & 99.2--99.8\% &
Tốt \\
Thời gian đọc 1 PID OBD2 & \textless{} 200 ms & 100--150 ms & Tốt \\
...
thực; chưa có watchdog & Đạt ở mức triển khai hiện tại \\
\end{longtable}
}
...
hỗ trợ MQTT 5.0, cung cấp các tính năng như message expiry, topic alias,
...
gồm: thiết bị gửi MQTT (\textasciitilde200 ms qua 4G), EMQX xử lý và
chuyển tiếp (\textasciitilde50 ms), backend xử lý và phát WebSocket
(\textasciitilde100 ms), và frontend render (\textasciitilde100 ms).
...
100--300 ms (phức tạp) & Tốt \\
API Server & Số request đồng thời & 100--500 req/s & Đạt yêu cầu \\
MQTT Broker & Độ trễ xử lý message & \textless{} 50 ms & Tốt \\
WebSocket & Độ trễ end-to-end & \textless{} 2 giây & Đạt yêu cầu \\
Frontend & First Contentful Paint & \textless{} 2 giây & Tốt \\
Frontend & Số xe hiển thị đồng thời & 50--100 xe & Đạt yêu cầu \\
PostgreSQL & Thời gian truy vấn có index & \textless{} 50 ms & Tốt \\
...
\textbar{} Giải pháp \textbar{} Chi phí thiết bị \textbar{} Phí dịch vụ
hàng tháng \textbar{} Tổng chi phí năm đầu \textbar{} Khả năng tùy biến
\textbar{} \textbar{}
-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-
\textbar{}
-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-
...
\textbar{}
-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-
\textbar{} -\/-\/- \textbar{} \textbar{} Hệ thống đề xuất \textbar{}
870.000--1.630.000 VND \textbar{} \textasciitilde70.000 VND (SIM 4G)
\textbar{} 1.710.000--2.470.000 VND \textbar{} Cao (mã nguồn mở)
\textbar{} \textbar{} GPS Tracker đơn giản (Việt Nam) \textbar{}
500.000--1.500.000 VND \textbar{} 50.000--100.000 VND \textbar{}
1.100.000--2.700.000 VND \textbar{} Thấp \textbar{} \textbar{} Fleet
Management thương mại (quốc tế) \textbar{} 5.000.000--12.500.000 VND
(\textasciitilde{}\(200–500 USD) | 500.000–1.250.000 VND (~\)20--50
USD/tháng) \textbar{} 11.000.000--27.500.000 VND \textbar{} Thấp (phụ
thuộc vendor) \textbar{} \textbar{} \textbar{} iTracking / Vietmap
Tracking \textbar{} 2.000.000--4.000.000 VND \textbar{} 100.000--300.000
VND \textbar{} 3.200.000--7.600.000 VND \textbar{} Trung bình \textbar{}
...
\begin{longtable}[]{@{}lllll@{}}
\toprule\noalign{}
Quy mô đội xe & Cấu hình VPS & Chi phí VPS/tháng & Chi phí SIM 4G/tháng
(tổng) & Tổng chi phí vận hành/tháng \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
10--30 xe & 2 vCPU, 4GB RAM, 80GB SSD & \textasciitilde250.000 VND
(\textasciitilde\$10 USD) & 700.000--2.100.000 VND & 950.000--2.350.000
VND \\
30--100 xe & 4 vCPU, 8GB RAM, 160GB SSD & \textasciitilde500.000 VND
(\textasciitilde\$20 USD) & 2.100.000--7.000.000 VND &
2.600.000--7.500.000 VND \\
100--500 xe & Kubernetes cluster (3 node) & \textasciitilde2.500.000 VND
(\textasciitilde\$100 USD) & 7.000.000--35.000.000 VND &
9.500.000--37.500.000 VND \\
\end{longtable}
}
...
\begin{longtable}[]{@{}lllllll@{}}
\toprule\noalign{}
ID & Rủi ro & Xác suất & Tác động & Mức độ rủi ro & Biện pháp giảm thiểu
& Trạng thái \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
bộ microSD và replay theo sequence khi mạng phục hồi & Đã triển khai \\
...
phía sau & Có phương án \\
R4 & Tấn công bảo mật (giả mạo thiết bị, chiếm quyền truy cập) & 3 -
Trung bình & 5 - Rất cao & \textbf{Cao} & Session-based auth với
SHA-256, MQTT ACL per device, HTTPS/TLS, Zod input validation, rate
limiting & Đã triển khai cơ bản \\
...
tầng, ACK timeout + retry backoff, GC theo quota & Đã giảm thiểu \\
...
μA trên thiết bị hiện tại, pin dự phòng 18650 1S & Đã triển khai \\
...
xuất hàng loạt & Thấp (tùy nhu cầu) \\
\end{longtable}
}
...
Kết quả đánh giá cho thấy hệ thống đã đáp ứng được các mục tiêu kỹ thuật
quan trọng của một thiết bị giám sát phương tiện hoàn chỉnh có thể vận
hành thực tế. Phần cứng giữ được mức tiêu thụ điện phù hợp, firmware vận
hành ổn định với state machine rõ ràng và đã bổ sung được luồng OTA cơ
bản, còn hạ tầng cloud duy trì độ trễ thấp cho bài toán theo dõi thời
gian thực. Về chi phí, BOM 870.000--1.630.000 VND cùng chi phí vận hành
thấp tạo ra lợi thế rõ rệt so với nhiều giải pháp thương mại cùng phân
khúc. Phần còn lại cần ưu tiên ở giai đoạn tiếp theo không nằm ở việc
thay đổi kiến trúc tổng thể, mà ở việc làm sâu hơn các lớp an toàn như
watchdog, bảo mật MQTT/TLS và kiểm thử vận hành dài hạn.

\chapterheading{CHƯƠNG 6. PHẢN HỒI VÀ BÀI HỌC KINH NGHIỆM -- REFLECTION AND}
CASE-STUDIES

\subsection{6.1. Ứng dụng kiến thức kỹ thuật -- Earlier course
work}\label{61-ux1ee9ng-dux1ee5ng-kiux1ebfn-thux1ee9c-kux1ef9-thuux1eadt--earlier-course-work}
...
\subsection{6.2. Giải quyết các vấn đề kỹ thuật phức tạp -- Complex
engineering
problems}\label{62-giux1ea3i-quyux1ebft-cuxe1c-vux1ea5n-ux111ux1ec1-kux1ef9-thuux1eadt-phux1ee9c-tux1ea1p--complex-engineering-problems}
...
\item
  \emph{Low Voltage Disconnect (LVD)}: Hiện thực LVD bằng comparator
  LM393 kết hợp ADC firmware, dùng ngưỡng profile: 12V (OFF=12.0V,
...
\subsection{6.3. Tác động đạo đức và xã hội -- Ethical and Social
impacts}\label{63-tuxe1c-ux111ux1ed9ng-ux111ux1ea1o-ux111ux1ee9c-vuxe0-xuxe3-hux1ed9i--ethical-and-social-impacts}
...
trữ trong database, có khả năng thu hồi ngay lập tức khi cần \\
5 & MQTT ACL per device & Mỗi thiết bị chỉ truy cập được dữ liệu của
mình, ngăn chặn truy cập trái phép dữ liệu thiết bị khác \\
\end{longtable}
}
...
\subsection{6.4. Tổng kết và bài học kinh nghiệm -- General reflection
and
case-studies}\label{64-tux1ed5ng-kux1ebft-vuxe0-buxe0i-hux1ecdc-kinh-nghiux1ec7m--general-reflection-and-case-studies}
...
\section{PHỤ LỤC 1: BÁO CÁO TÀI CHÍNH - FINANCE
...
\begin{longtable}[]{@{}lllllll@{}}
\toprule\noalign{}
STT & Linh kiện & Model / Thông số & Số lượng & Đơn giá (VND) & Thành
tiền (VND) & Ghi chú \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
MCU chính, 16MB Flash, 8MB PSRAM \\
2 & LTE + GNSS & SIMCom SIM7600CE-T & 1 bộ & 330.000 & 330.000 & Modem
LTE Cat-4 tích hợp GPS/GNSS \\
...
input 5V từ MP2482, dòng theo PROG \\
7 & Buck 3.3V & Mạch XL1509 3.3E & 1 & 18.000 & 18.000 & 12--24V
-\textgreater{} 3.3V cấp ESP32-S3 \\
8 & Buck 5V & Mạch MP2482 (12V/24V-\textgreater5V) & 1 & 15.000 & 15.000
& Tạo bus 5V chính \\
9 & Buck 3.8V/4V & Mạch TPS54231 & 1 & 20.000 & 20.000 & 12--24V
-\textgreater{} \textasciitilde4V cấp modem SIM7600CE-T \\
10 & Boost converter & Mạch SX1308 (3.7V-\textgreater5V) & 1 & 12.000 &
12.000 & Tăng áp từ pin dự phòng \\
11 & Diode OR & 1N5822 (Schottky) & 2 & 2.500 & 5.000 & OR nguồn giữa
nhánh 5V chính và backup \\
12 & Comparator & LM393 & 1 & 8.000 & 8.000 & Cho mạch Low Voltage
Disconnect \\
...
nối nguồn ắc quy xe (12V hoặc 24V) \\
17 & Tụ điện, điện trở & Linh kiện thụ động (combo) & 1 bộ & 30.000 &
30.000 & Tụ lọc, điện trở chia áp ADC (R1=100k, R2=10k), LED \\
18 & PCB chính & PCB 2 lớp theo layout đề tài \textasciitilde50x50mm & 1
& 20.000 & 20.000 & Bo mạch chính của thiết bị \\
19 & Hộp đựng & Hộp nhựa ABS 120x80x40mm & 1 & 25.000 & 25.000 & Vỏ bảo
vệ thiết bị \\
20 & Dây kết nối & Dây nối, header, jumper & 1 bộ & 20.000 & 20.000 &
Dây kết nối nội bộ \\
& & & & \textbf{Tổng cộng} & \textbf{1.183.000} & \\
\end{longtable}
}
...
DigitalOcean / Vultr / Viettel IDC \\
2 & SIM 4G data & Gói cước data IoT & 70.000 & Mỗi thiết bị 1 SIM \\
3 & Tên miền & Domain .com & 25.000 & \textasciitilde300.000 VND/năm \\
4 & SSL Certificate & Let\textquotesingle s Encrypt & 0 & Miễn phí, tự
động gia hạn \\
& & & \textbf{Tổng hàng tháng} & \textbf{395.000--595.000} \\
\end{longtable}
}
...
\section{PHỤ LỤC 2: CÁC TIÊU CHUẨN THIẾT KẾ -
...
\section{PHỤ LỤC 3: KẾ HOẠCH THỰC HIỆN - ASSIGNMENT AND
...
\pandocbounded{\safeincludesvg{./assets/figures/thesis-14-phu-luc-01.svg}}

\emph{Hình PL-3.1: Biểu đồ Gantt kế hoạch thực hiện dự án (24 tuần)}
...
\section{PHỤ LỤC 4: TÀI LIỆU BỔ TRỢ - SUPPORTING
...
\item
  \textbf{Branch chính:} \texttt{main} (nhánh ổn định để triển khai)
\item
  \textbf{Branch phát triển:} \texttt{feature/system-coding} (nhánh phát
  triển đang sử dụng)
\item
...
trips \\
4 & \texttt{devices} & Thông tin thiết bị tracker & N:1 với vehicles \\
5 & \texttt{customers} & Thông tin khách hàng & 1:N với trips \\
6 & \texttt{trips} & Hành trình cho thuê & N:1 với vehicles,
customers \\
7 & \texttt{alerts} & Cảnh báo hệ thống & N:1 với vehicles, devices \\
8 & \texttt{geofences} & Vùng địa lý (hàng rào ảo) & N:N với vehicles \\
9 & \texttt{commands} & Lệnh điều khiển thiết bị & N:1 với devices \\
10 & \texttt{audit\_logs} & Nhật ký thao tác & N:1 với users \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\texttt{vehicle\_latitude} & \texttt{device\_id} & Vĩ độ GNSS \\
\texttt{vehicle\_longitude} & \texttt{device\_id} & Kinh độ GNSS \\
\texttt{vehicle\_speed} & \texttt{device\_id} & Tốc độ \\
\texttt{vehicle\_vibration} & \texttt{device\_id} & Mức rung từ IMU \\
...
\bottomrule\noalign{}
\endlastfoot
Auth & POST & \texttt{/api/v1/auth/login} & Đăng nhập \\
Auth & POST & \texttt{/api/v1/auth/logout} & Đăng xuất \\
Auth & GET & \texttt{/api/v1/auth/me} & Thông tin người dùng hiện tại \\
Vehicles & GET & \texttt{/api/v1/vehicles} & Danh sách phương tiện \\
Vehicles & POST & \texttt{/api/v1/vehicles} & Thêm phương tiện \\
Vehicles & GET & \texttt{/api/v1/vehicles/:id} & Chi tiết phương tiện \\
Devices & GET & \texttt{/api/v1/devices} & Danh sách thiết bị \\
Devices & POST & \texttt{/api/v1/devices} & Đăng ký thiết bị mới \\
Devices & POST & \texttt{/api/v1/devices/:id/ota} & Kích hoạt OTA cho
thiết bị \\
Devices & POST & \texttt{/api/v1/devices/:id/ota/rollback} & Yêu cầu
rollback firmware \\
Telemetry & GET & \texttt{/api/v1/devices/:id/telemetry} & Dữ liệu
telemetry theo thiết bị \\
Telemetry & GET & \texttt{/api/v1/telemetry/history} & Truy vấn lịch sử
telemetry \\
Alerts & GET & \texttt{/api/v1/alerts} & Danh sách cảnh báo \\
Alerts & PUT & \texttt{/api/v1/alerts/:id/acknowledge} & Xác nhận cảnh
báo \\
Geofences & GET & \texttt{/api/v1/geofences} & Danh sách geofences \\
Geofences & POST & \texttt{/api/v1/geofences} & Tạo geofence mới \\
Commands & POST & \texttt{/api/v1/devices/:id/command} & Gửi lệnh đến
thiết bị \\
Trips & GET & \texttt{/api/v1/trips} & Danh sách hành trình \\
Customers & GET & \texttt{/api/v1/customers} & Danh sách khách hàng \\
\end{longtable}
}
...
(\texttt{.env.example}) có sẵn trong mỗi thư mục dịch vụ.
...
\bottomrule\noalign{}
\endlastfoot
\texttt{POSTGRESQL\_HOST} & Backend & Địa chỉ PostgreSQL server & Có \\
\texttt{POSTGRESQL\_PORT} & Backend & Cổng PostgreSQL (mặc định: 5432) &
Có \\
\texttt{POSTGRESQL\_DATABASE} & Backend & Tên cơ sở dữ liệu & Có \\
\texttt{POSTGRESQL\_USER} & Backend & Tên đăng nhập PostgreSQL & Có \\
\texttt{POSTGRESQL\_PASSWORD} & Backend & Mật khẩu PostgreSQL & Có \\
\texttt{VICTORIAMETRICS\_URL} & MqttBridge & URL VictoriaMetrics & Có \\
\texttt{VICTORIALOGS\_URL} & MqttBridge & URL VictoriaLogs & Có \\
\texttt{MQTT\_BROKER\_URL} & Backend, MqttBridge & URL EMQX broker &
Có \\
\texttt{FIRMWARE\_PUBLIC\_BASE\_URL} & Backend & Base URL công khai để
thiết bị tải file OTA & Có cho OTA \\
\texttt{SESSION\_SECRET} & Backend & Khóa bí mật cho session (min 32 ký
tự) & Có \\
\texttt{CORS\_ORIGIN} & Backend & URL frontend cho CORS & Có \\
\end{longtable}
}
...
\BuiltInTok{cd}\NormalTok{ iot{-}vehicle{-}tracking{-}system{-}cloud/Tracking\_PostgreSQL }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ ../Tracking\_EMQX }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ ../Tracking\_VictoriaMetrics }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
\BuiltInTok{cd}\NormalTok{ ../Tracking\_VictoriaLogs }\KeywordTok{\&\&} \ExtensionTok{docker{-}compose}\NormalTok{ up }\AttributeTok{{-}d}
...
EMQX Dashboard & http://localhost:18083 & admin / emqx\_dev\_2026 \\
