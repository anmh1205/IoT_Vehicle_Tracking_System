...
> **Ghi chú biên tập:** Các biểu mẫu nhận xét, biên bản và mục trang ở phần đầu được giữ lại để bảo đảm đủ cấu trúc hồ sơ nộp đồ án. Những trường còn để trống hoặc dùng placeholder sẽ được điền ở giai đoạn hoàn thiện bản in và dàn trang cuối cùng.
...
Tôi xin cam đoan đồ án tốt nghiệp với đề tài **"Thiết kế hệ thống IoT cho ứng dụng quản lý phương tiện giao thông trong lĩnh vực cho thuê xe tự lái"** là công trình nghiên cứu của riêng tôi dưới sự hướng dẫn của TS. Nguyễn Đức Nam.
...
**Sinh viên thực hiện:** Lê Trọng An&emsp;&emsp;**MSSV:** 21010389
...
**Title:** Design of an IoT System for Vehicle Management in Self-Drive Car Rental Services

**Student:** Lê Trọng An&emsp;&emsp;**Student ID:** 21010389
...
The result is a complete end-to-end IoT vehicle tracking system, from hardware to software, capable of real-time location tracking, OBD2 diagnostic data retrieval, geofencing, automated alerts, remote firmware updates, and fleet-management support for self-drive car rental services.
...
> **Ghi chú biên tập:** Cột số trang trong mục lục sẽ được cập nhật sau bước dàn trang PDF/in chính thức. Ở bản Markdown này, mục lục chủ yếu đóng vai trò bản đồ điều hướng theo cấu trúc chương và mục.
...
> **Ghi chú biên tập:** Danh mục này dùng để rà đủ đối tượng tham chiếu trong tài liệu. Số trang sẽ được đồng bộ ở bản xuất cuối sau khi hoàn tất dàn trang.
...
> **Ghi chú biên tập:** Danh mục này hỗ trợ kiểm tra đủ hình, sơ đồ và đồ thị trong toàn bộ luận văn. Cột trang sẽ được chốt sau khi xuất bản in cuối cùng.
...
> **Hướng dẫn đọc nhanh:** Chương 1–2 xác lập bối cảnh, yêu cầu và ràng buộc của bài toán. Chương 3–4 tập trung vào quyết định thiết kế và quá trình triển khai thực tế. Chương 5–6 tổng hợp đánh giá, khuyến nghị và bài học kinh nghiệm; phần references và appendices dùng để tra cứu lại nguồn, cấu hình và tài liệu bổ trợ khi cần.
...
Nếu nhóm yêu cầu chức năng mô tả hệ thống phải làm gì, thì nhóm yêu cầu phi chức năng dưới đây xác định hệ thống phải vận hành ở mức nào. Đây là cơ sở để đánh giá liệu giải pháp đề xuất có đủ nhanh, ổn định, an toàn và dễ mở rộng trong bối cảnh khai thác thực tế hay không.

**NFR-01: Hiệu suất (Performance)**

- Độ trễ end-to-end từ thiết bị đến dashboard dưới 3 giây trong điều kiện mạng bình thường
- Thời gian phản hồi API dưới 200 ms với 95% request
...
- MQTT QoS 1 cho các tin nhắn cảnh báo để bảo đảm gửi ít nhất một lần
...
Nhìn tổng thể, nhóm yêu cầu phi chức năng này là căn cứ trực tiếp cho các quyết định kiến trúc ở Chương 3 và các phép đo kiểm ở Chương 4.
...
Bảng 2.5 tóm tắt nhu cầu của từng nhóm liên quan trực tiếp đến hệ thống. Cách trình bày này giúp tránh việc thiết kế chỉ theo góc nhìn kỹ thuật, đồng thời cho thấy vì sao một số tính năng được ưu tiên cao hơn các tính năng còn lại.
...
Điểm đáng chú ý là doanh nghiệp vận hành và quản trị viên hệ thống có mức ưu tiên cao nhất, nên các quyết định về theo dõi thời gian thực, cảnh báo và khả năng quản trị phải được xem là trục chính của giải pháp.
...
Sau khi xác định yêu cầu của từng bên liên quan, bước tiếp theo là đối chiếu các yêu cầu đó với các nhóm chức năng cốt lõi của hệ thống. Bảng 2.6 cho thấy mỗi chức năng không tồn tại độc lập, mà thường đồng thời phục vụ nhiều mục tiêu vận hành khác nhau.
...
Ma trận truy xuất trên cho thấy các chức năng hệ thống (FC-01 đến FC-05) bao phủ toàn bộ yêu cầu của các bên liên quan chính. Đáng chú ý, FC-04 (quản lý năng lượng) và FC-05 (giao diện web) xuất hiện với tần suất cao nhất, cho thấy đây không chỉ là tính năng hỗ trợ mà là hai trụ cột trực tiếp quyết định khả năng vận hành của giải pháp.
...
| 17  | PCB 2 lớp (~50x50 mm)        | Cái    | 1   | 50.000–100.000     | Bo mạch theo layout của đề tài        |
...
Tổng chi phí ước tính cho toàn bộ phần cứng hệ thống tracker nằm trong khoảng **872.000–1.635.000 VND**, phù hợp với ngân sách đồ án tốt nghiệp. Mức chi phí này phản ánh phương án phần cứng của đề tài với bo mạch 2 lớp do nhóm phát triển, các linh kiện được lắp trực tiếp trên bo mạch và hoàn thiện thành một thiết bị độc lập.
...
Sau khi chốt Next.js + React là hướng phù hợp nhất ở mục 3.1.4, phần này đi sâu vào cách hiện thực lớp giao diện. Trọng tâm không chỉ là chọn framework, mà còn là cách tổ chức state, cấu trúc ứng dụng, bản đồ thời gian thực và trải nghiệm sử dụng trong bối cảnh một dashboard vận hành nhiều màn hình.

#### 3.2.4.1. Lựa chọn công nghệ Frontend (Technology Selection)

##### a) Framework ứng dụng web

Để lựa chọn framework phù hợp cho lớp giao diện, nhóm so sánh Next.js, Nuxt.js và Vite + React theo các tiêu chí hiệu năng, khả năng mở rộng và trải nghiệm phát triển. Bảng 3.24 tập trung vào các yếu tố ảnh hưởng trực tiếp đến bài toán dashboard thời gian thực, thay vì chỉ so sánh framework ở mức tổng quát.
...
**Kết luận:** Zustand được chọn vì API đơn giản, kích thước cực nhỏ (~1.1 KB) và phù hợp với yêu cầu của hệ thống, nơi token phiên đăng nhập chỉ lưu trong bộ nhớ (memory-only, không persist ra localStorage) nhằm tăng tính bảo mật. Cách tách client state, server state và real-time state cũng giúp ứng dụng tránh bị dồn quá nhiều trách nhiệm vào một lớp quản lý trạng thái duy nhất.
...
Luồng dữ liệu trong ứng dụng Frontend tuân theo mô hình một chiều (unidirectional data flow), đồng thời kết hợp ba nguồn dữ liệu chính. Hình 3.15a giúp người đọc nhìn rõ vai trò riêng của REST API, state cục bộ và kênh thời gian thực trong cùng một ứng dụng.
...
Sau khi phân tích riêng từng tầng ở mục 3.2, bước này gom toàn bộ quyết định thiết kế vào một ma trận tổng hợp để kiểm tra tính nhất quán của hệ thống. Bảng 3.29 cho thấy phương án được chọn ở mỗi tầng đều bám trực tiếp vào các ràng buộc đã nêu ở Chương 2.
...
Từ kết quả phân tích và đánh giá ở mục 3.3, phương án thiết kế tối ưu cho hệ thống IoT giám sát phương tiện được tổng hợp lại thành một kiến trúc thống nhất. Hình 3.23 đóng vai trò như bản chốt cuối của Chương 3 trước khi chuyển sang phần triển khai ở Chương 4.
...
Chương 3 đã trình bày có hệ thống quá trình phân tích, đề xuất và lựa chọn phương án thiết kế cho toàn bộ hệ thống IoT giám sát phương tiện trên bốn tầng: phần cứng, firmware, backend/cloud và frontend. Thông qua các bảng so sánh và ma trận đánh giá, phương án tối ưu đã được xác lập theo các tiêu chí hiệu năng, chi phí và khả năng mở rộng.

Quan trọng hơn, chương này đã biến các yêu cầu và ràng buộc ở Chương 2 thành các lựa chọn kỹ thuật có thể triển khai được. Trên nền tảng đó, Chương 4 sẽ chuyển từ mức quyết định thiết kế sang cách hiện thực cụ thể và kết quả đo kiểm của hệ thống.
...
![Hình 4.16a - Chuỗi bước OTA trên firmware từ nhận lệnh đến xác nhận sau reboot](./assets/figures/thesis-08-chuong-4-trien-khai-firmware-02.svg)
...
Phần này mô tả cách phương án frontend ở Chương 3 được hiện thực thành dashboard vận hành thực tế. Trọng tâm là cấu trúc ứng dụng, các trang nghiệp vụ chính, cơ chế realtime và cách đóng gói để có thể triển khai cùng các dịch vụ cloud khác.
...
Frontend được tổ chức theo kiến trúc Feature-Sliced, trong đó mỗi tính năng (feature) được gom nhóm vào một thư mục riêng bao gồm các thành phần UI, hooks, types, và utilities liên quan. Cách tiếp cận này giúp dashboard giữ được cấu trúc rõ ràng khi số lượng màn hình và nghiệp vụ tăng dần theo thời gian.
...
Các trang dưới đây đại diện cho những điểm chạm nghiệp vụ quan trọng nhất của người vận hành. Việc mô tả theo từng trang giúp người đọc hình dung rõ dashboard hỗ trợ công việc hằng ngày như thế nào, thay vì chỉ nhìn frontend như một lớp hiển thị đơn thuần.
...
Frontend sử dụng chiến lược quản lý trạng thái kết hợp. Mục tiêu là tách rõ dữ liệu nào cần đồng bộ với backend, dữ liệu nào chỉ phục vụ giao diện cục bộ, và dữ liệu nào phải được cập nhật theo thời gian thực.
...
Bảng 4.9 cho thấy frontend không được phát triển trong một lần duy nhất, mà đi theo lộ trình từ khung ứng dụng, tính năng cốt lõi đến các tính năng nâng cao. Cách chia pha này giúp hệ thống có thể tạo giá trị sớm nhưng vẫn giữ chỗ cho các nhu cầu mở rộng sau này.
...
Phần Docker dưới đây cho thấy frontend đã được chuẩn bị theo hướng sẵn sàng triển khai, không chỉ dừng ở mức chạy cục bộ trong môi trường phát triển. Người đọc cần xem block này như minh họa cho cách đóng gói production, không phải chỉ là danh sách lệnh build.
...
Dockerfile sử dụng 3 giai đoạn: `deps` (cài đặt dependencies), `builder` (build ứng dụng), và `runner` (chạy production). Giai đoạn `runner` chỉ sao chép các file cần thiết từ giai đoạn `builder`, giúp giảm đáng kể kích thước image cuối cùng. Ứng dụng chạy với user `nextjs` (không phải root) để tăng tính bảo mật. Nhờ đó, frontend có thể tham gia đồng nhất vào mô hình triển khai container hóa chung của toàn hệ thống cloud.

---

### 4.2.6. Cấu hình giám sát hệ thống (Monitoring & Observability)

Phần giám sát hệ thống được đưa vào riêng vì đây là lớp giúp vận hành và phân tích sự cố sau triển khai. Với một hệ thống IoT nhiều dịch vụ, khả năng quan sát không phải phần phụ, mà là điều kiện để phát hiện lỗi và giữ độ tin cậy khi số lượng thiết bị tăng lên.
...
Grafana được sử dụng làm lớp trực quan hóa (visualization layer), kết nối tới cả VictoriaMetrics và VictoriaLogs để hiển thị các dashboard giám sát. Các dashboard chính dưới đây phản ánh cả sức khỏe hạ tầng lẫn trạng thái vận hành của đội xe.
...
Để chuyển hệ thống từ môi trường thử nghiệm sang môi trường vận hành thực tế, nhóm triển khai áp dụng checklist hardening theo các mức ưu tiên sau. Phần này được tách riêng để nhấn mạnh rằng một hệ thống hoạt động được trong lab chưa đồng nghĩa với việc đã đủ an toàn để đưa vào khai thác thật.
...
Phần triển khai cloud cho thấy hệ thống không chỉ dừng ở mức ghép nối các dịch vụ riêng lẻ, mà đã hình thành một chuỗi xử lý dữ liệu tương đối hoàn chỉnh từ thiết bị đến dashboard. MQTT Bridge giữ vai trò trung tâm trong việc tiếp nhận, xác thực và phân phối dữ liệu sang các hệ lưu trữ phù hợp, trong khi Backend API và Frontend Dashboard đảm nhiệm lớp khai thác và giám sát vận hành thời gian thực.
...
Trước khi đi vào số liệu, cần mô tả rõ môi trường và công cụ thử nghiệm để người đọc hiểu giới hạn của các kết quả được trình bày. Cách tiếp cận này giúp phân biệt giữa giá trị đã đo trực tiếp, giá trị ước tính và các chỉ số còn cần lặp lại trên nhiều mẫu hơn.
...
Thông tin này cho thấy kết quả đã có cơ sở thực nghiệm trên xe thật, nhưng phạm vi mẫu vẫn còn hẹp và cần được hiểu đúng khi diễn giải các kết luận ở các mục sau.
...
> **Ghi chú sử dụng:** Danh mục tham khảo theo chương được giữ lại để người đọc đối chiếu nhanh các nguồn gắn trực tiếp với phần đo kiểm và đánh giá trong chương này. Danh mục References tổng ở cuối tài liệu vẫn là nơi tập hợp đầy đủ toàn bộ nguồn đã sử dụng.
...
EMQX xử lý tin nhắn MQTT từ các thiết bị IoT với độ tin cậy cao. Broker hỗ trợ MQTT 5.0, cung cấp các tính năng như message expiry, topic alias, user properties và ACL theo từng thiết bị. Trong kiến trúc triển khai hiện tại, phần phân luồng và xử lý dữ liệu chủ yếu do MQTT Bridge đảm nhiệm; EMQX giữ vai trò broker trung tâm, còn Rules Engine chỉ là khả năng bổ trợ chứ không phải tuyến xử lý nghiệp vụ chính.
...
Kinh nghiệm rút ra từ dự án, đặc biệt ở các mảng kiến trúc hệ thống, quản lý năng lượng cho thiết bị IoT, bảo mật backend và tổ chức luồng dữ liệu thời gian thực, là nền tảng quan trọng cho công việc chuyên môn sau này. Điều này cũng khép lại mạch phản tư của chương: từ kiến thức đã dùng, các bài toán đã giải, đến những nguyên tắc cần giữ lại cho các dự án kỹ thuật phức tạp về sau.
...
> **Ghi chú sử dụng:** Mục tham khảo ngắn này nhấn mạnh nguồn được viện dẫn trực tiếp trong phần phản tư và bài học kinh nghiệm. Danh mục References tổng bên dưới mới là danh mục hợp nhất cho toàn bộ luận văn.

# TÀI LIỆU TRÍCH DẪN - REFERENCES

Danh mục tài liệu tham khảo được chia theo nhóm để người đọc dễ truy vết nguồn học thuật, tài liệu kỹ thuật và tài liệu trực tuyến đã được sử dụng trong đồ án. Cách phân nhóm này cũng giúp kiểm tra nhanh mức độ cân bằng giữa nguồn nền tảng, nguồn triển khai và nguồn cập nhật theo công nghệ.
...
| 9   | Buck 3.8V/4V      | Mạch TPS54231                         | 1        | 20.000        | 20.000           | 12–24V -> ~4V cấp modem SIM7600CE-T                 |
...
| 18  | PCB chính         | PCB 2 lớp theo layout đề tài ~50x50mm | 1        | 20.000        | 20.000           | Bo mạch chính của thiết bị                          |
...
Nhìn chung, Phụ lục 1 giúp củng cố luận điểm rằng giải pháp đề xuất không chỉ khả thi về kỹ thuật mà còn có cơ sở kinh tế để triển khai ở quy mô nhỏ và trung bình.

---

# PHỤ LỤC 2: CÁC TIÊU CHUẨN THIẾT KẾ - STANDARDS

Phụ lục này gom các tiêu chuẩn và nguyên tắc thiết kế được tham chiếu xuyên suốt đồ án. Mục đích là giúp người đọc tra cứu nhanh nền tảng chuẩn hóa đứng sau các lựa chọn kỹ thuật, thay vì phải tìm lại từng chỗ rải rác trong các chương trước.
...
**Mô tả:** MQTT (Message Queuing Telemetry Transport) phiên bản 5.0 là tiêu chuẩn OASIS cho giao thức truyền thông IoT, được thiết kế cho các thiết bị có tài nguyên hạn chế và băng thông thấp. Trong phạm vi đồ án, đây là chuẩn kết nối giữ vai trò trung tâm giữa thiết bị, broker và các dịch vụ xử lý dữ liệu.
...
Tổng thể, Phụ lục 2 đóng vai trò như lớp nền chuẩn hóa cho các quyết định thiết kế đã xuất hiện trong các chương chính, giúp người đọc đối chiếu nhanh giữa giải pháp và cơ sở tiêu chuẩn tương ứng.

---

# PHỤ LỤC 3: KẾ HOẠCH THỰC HIỆN - ASSIGNMENT AND TIMELINES

Phụ lục này cung cấp góc nhìn tiến độ để người đọc hiểu dự án đã được chia pha và phối hợp công việc như thế nào theo thời gian. Đây là phần bổ trợ quan trọng vì nó nối các quyết định kỹ thuật với thực tế triển khai của nhóm.
...
Biểu đồ dưới đây giúp nhìn nhanh phần chồng chéo giữa các giai đoạn. Đây là điểm quan trọng, vì dự án không đi theo chuỗi tuần tự tuyệt đối mà có chủ đích mở song song một số nhánh để rút ngắn thời gian thực hiện.
...
Như vậy, Phụ lục 3 cho thấy các kết quả kỹ thuật của đồ án được tạo ra từ một lộ trình triển khai có phân pha và có chồng chéo hợp lý, thay vì phát triển rời rạc theo từng thành phần độc lập.

---

# PHỤ LỤC 4: TÀI LIỆU BỔ TRỢ - SUPPORTING MATERIALS

Phụ lục cuối cùng tập hợp các thông tin tra cứu nhanh phục vụ việc tái hiện, kiểm tra hoặc tiếp tục phát triển hệ thống sau đồ án. Các mục dưới đây mang tính vận hành nhiều hơn là lập luận học thuật, nên cần được trình bày ngắn gọn và theo thứ tự dễ lần theo.
...
Mục này giúp người đọc định vị nhanh nơi lưu schema và nhận diện các bảng quan trọng của hệ thống. Thay vì trình bày toàn bộ định nghĩa SQL, phụ lục chỉ giữ mức thông tin vừa đủ để hỗ trợ tra cứu và hiểu quan hệ dữ liệu.
...
Mục này tóm tắt điểm truy cập và các nhóm endpoint chính để người đọc có thể hình dung nhanh phạm vi của lớp backend. Phụ lục không thay thế Swagger/OpenAPI, mà đóng vai trò như bản đồ định hướng trước khi đi vào tài liệu chi tiết.
...
Mục cấu hình môi trường giúp người đọc nắm nhanh các biến quan trọng cần có trước khi khởi chạy hệ thống. Đây là phần dễ gây nhầm lẫn khi tái hiện dự án, nên chỉ giữ các biến cốt lõi thay vì liệt kê toàn bộ cấu hình chi tiết.
...
**Checkpoint sau khi chạy:** Docker network `tracking-network` phải tồn tại; các dịch vụ hạ tầng phải lên container bình thường; Backend và Frontend phải khởi động không báo thiếu biến môi trường; MQTT Bridge phải kết nối được tới broker và các hệ lưu trữ. Nếu một bước chưa đạt các dấu hiệu này, nên dừng tại đó để kiểm tra thay vì chạy tiếp toàn bộ chuỗi lệnh.

**Truy cập hệ thống:**

| Dịch vụ         | URL                            | Tài khoản mặc định          |
| --------------- | ------------------------------ | --------------------------- |
| Frontend Web    | http://localhost:4002          | admin / Admin@2026 (demo)   |
| Backend API     | http://localhost:4000          | —                           |
| Swagger Docs    | http://localhost:4000/api-docs | —                           |
| EMQX Dashboard  | http://localhost:18083         | admin / emqx_dev_2026 (dev) |
| Grafana         | http://localhost:4001          | admin / admin (default)     |
| VictoriaMetrics | http://localhost:8428          | —                           |

Tóm lại, Phụ lục 4 đóng vai trò như bộ tài liệu tra cứu thực hành để người đọc có thể lần theo mã nguồn, cấu hình, API và các bước dựng hệ thống mà không phải quay lại toàn bộ nội dung chính.
