...
\thispagestyle{empty}
\noindent
\begin{minipage}[t][0.90\textheight][t]{0.15\textwidth}
  \centering
  \vspace{0.05\textheight}
  \rotatebox{90}{\textbf{\Large LE TRONG AN}}\\[1.6cm]
  \rotatebox{90}{\textbf{\large KY THUAT CO DIEN TU}}
\end{minipage}\hfill
\begin{minipage}[t][0.90\textheight][t]{0.80\textwidth}
  \begin{center}
    \textbf{BỘ GIÁO DỤC VÀ ĐÀO TẠO}\\
    \textbf{ĐẠI HỌC PHENIKAA}\\[0.25cm]
    \rule{0.58\linewidth}{0.6pt}
    \vspace*{2.0cm}
    ...
    \begin{minipage}{0.92\linewidth}
      \raggedright
      \textbf{Sinh viên:} Lê Trọng An\\
      \textbf{Mã số sinh viên:} 21010389 \hfill \textbf{Khóa:} K15\\
      \textbf{Ngành:} Kỹ thuật Cơ Điện tử \hfill \textbf{Hệ:} Đại học chính quy\\
...
{\Large\textbf{IN SELF-DRIVE CAR RENTAL SERVICES}}\\[0.2cm]
\textbf{Semester: I Academic year: 2025--2026}
\vfill

\begin{tabular}{lll}
\textbf{Project Team:} & & \\
\textbf{Student name} & \textbf{Student ID} & \textbf{Cohort} \\
...
\begin{center}
  \textbf{ĐẠI HỌC PHENIKAA}\\
  \textbf{KHOA CƠ KHÍ -- CƠ ĐIỆN TỬ}\\[0.25cm]
  \rule{0.56\linewidth}{0.6pt}
  \vspace*{1.2cm}

  \textbf{MEM710071}\\
  {\Large\textbf{ĐỒ ÁN TỐT NGHIỆP}}\\
  {\large\textbf{THIẾT KẾ HỆ THỐNG IOT CHO ỨNG DỤNG QUẢN LÝ}}\\
  {\large\textbf{PHƯƠNG TIỆN GIAO THÔNG TRONG LĨNH VỰC CHO THUÊ XE TỰ LÁI}}\\
  \vspace{0.4cm}
  \textbf{Học kỳ I Năm học 2025--2026}
  \vfill
  ...
  \vspace{0.5cm}
  \textbf{Giáo viên hướng dẫn:} TS. Nguyễn Đức Nam
...
\textbf{Giảng viên phản biện:} \dotfill \hfill \textbf{Khoa:} \dotfill\\
\textbf{Tên đề tài:} Thiết kế hệ thống IoT cho ứng dụng quản lý phương tiện giao thông trong lĩnh vực cho thuê xe tự lái.\\
\textbf{Sinh viên thực hiện:} Lê Trọng An \hfill \textbf{Lớp:} K15-KTCĐT2\\
\textbf{Giảng viên hướng dẫn:} TS. Nguyễn Đức Nam
...
\thispagestyle{empty}
\begin{center}
  \textbf{\Large GIẢI TRÌNH CÁC CHỈNH SỬA}\\[0.3cm]
  \emph{(Nếu có)}
\end{center}
\clearpage
...
Tôi đã thực hiện đồ án tốt nghiệp với đề tài: \textbf{Thiết kế hệ thống IoT cho ứng dụng quản lý phương tiện giao thông trong lĩnh vực cho thuê xe tự lái}.
...
\thesissignaturepair{GIẢNG VIÊN HƯỚNG DẪN}{TS. Nguyễn Đức Nam}{SINH VIÊN THỰC HIỆN}{Lê Trọng An}
