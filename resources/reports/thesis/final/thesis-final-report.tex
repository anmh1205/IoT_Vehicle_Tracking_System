...
\hline
\endlastfoot
\textbf{Authentication} & POST & \nolinkurl{/api/v1/auth/login} & Đăng nhập &
Không \\
& GET & \nolinkurl{/api/v1/auth/me} & Thông tin người dùng hiện tại & Có \\
& POST & \nolinkurl{/api/v1/auth/logout} & Đăng xuất & Có \\
\textbf{Devices} & GET & \nolinkurl{/api/v1/devices} & Danh sách thiết bị & Có \\
& POST & \nolinkurl{/api/v1/devices} & Tạo thiết bị mới & Có \\
& POST & \nolinkurl{/api/v1/devices/:id/ota} & Gửi lệnh OTA đến thiết bị & Có \\
& POST & \nolinkurl{/api/v1/devices/:id/ota/rollback} & Yêu cầu rollback firmware &
Có \\
\textbf{Vehicles} & GET & \nolinkurl{/api/v1/vehicles} & Danh sách xe & Có \\
& POST & \nolinkurl{/api/v1/vehicles} & Tạo xe mới & Có \\
\textbf{IoT Data} & POST & \nolinkurl{/api/v1/iot/data} & Gửi dữ liệu cảm biến &
Không \\
\textbf{Telemetry} & GET & \nolinkurl{/api/v1/devices/:id/telemetry} & Dữ liệu
telemetry theo thiết bị & Có \\
& GET & \nolinkurl{/api/v1/telemetry/history} & Truy vấn lịch sử telemetry & Có \\
\textbf{Dashboard} & GET & \nolinkurl{/api/v1/dashboard/stats} & Thống kê tổng quan
& Có \\
\textbf{Firmware} & POST & \nolinkurl{/api/v1/firmware/upload} & Tải lên firmware &
Có \\
& GET & \nolinkurl{/api/v1/firmware/:id/download} & Tải file firmware để OTA & Có \\
\end{longtable}
}
...
đây, cảnh báo \\
Vehicles & \nolinkurl{/api/v1/vehicles} & Có & CRUD xe, gán thiết bị \\
Customers & \nolinkurl{/api/v1/customers} & Có & CRUD khách hàng \\
Trips & \nolinkurl{/api/v1/trips} & Có & CRUD chuyến đi, lịch sử \\
Alerts & \nolinkurl{/api/v1/alerts} & Có & Quản lý cảnh báo \\
Geofences & \nolinkurl{/api/v1/geofences} & Có & CRUD vùng địa lý \\
...
\endlastfoot
Auth & POST & \nolinkurl{/api/v1/auth/login} & Đăng nhập \\
Auth & POST & \nolinkurl{/api/v1/auth/logout} & Đăng xuất \\
Auth & GET & \nolinkurl{/api/v1/auth/me} & Thông tin người dùng hiện tại \\
Vehicles & GET & \nolinkurl{/api/v1/vehicles} & Danh sách phương tiện \\
Vehicles & POST & \nolinkurl{/api/v1/vehicles} & Thêm phương tiện \\
Vehicles & GET & \nolinkurl{/api/v1/vehicles/:id} & Chi tiết phương tiện \\
Devices & GET & \nolinkurl{/api/v1/devices} & Danh sách thiết bị \\
Devices & POST & \nolinkurl{/api/v1/devices} & Đăng ký thiết bị mới \\
...
telemetry \\
Alerts & GET & \nolinkurl{/api/v1/alerts} & Danh sách cảnh báo \\
Alerts & PUT & \nolinkurl{/api/v1/alerts/:id/acknowledge} & Xác nhận cảnh
báo \\
Geofences & GET & \nolinkurl{/api/v1/geofences} & Danh sách geofences \\
Geofences & POST & \nolinkurl{/api/v1/geofences} & Tạo geofence mới \\
Commands & POST & \nolinkurl{/api/v1/devices/:id/command} & Gửi lệnh đến
thiết bị \\
Trips & GET & \nolinkurl{/api/v1/trips} & Danh sách hành trình \\
Customers & GET & \nolinkurl{/api/v1/customers} & Danh sách khách hàng \\
\end{longtable}
}
...
\hline
\endlastfoot
\nolinkurl{POSTGRESQL_HOST} & Backend & Địa chỉ PostgreSQL server & Có \\
\nolinkurl{POSTGRESQL_PORT} & Backend & Cổng PostgreSQL (mặc định: 5432) &
Có \\
\nolinkurl{POSTGRESQL_DATABASE} & Backend & Tên cơ sở dữ liệu & Có \\
\nolinkurl{POSTGRESQL_USER} & Backend & Tên đăng nhập PostgreSQL & Có \\
\nolinkurl{POSTGRESQL_PASSWORD} & Backend & Mật khẩu PostgreSQL & Có \\
\nolinkurl{VICTORIAMETRICS_URL} & MqttBridge & URL VictoriaMetrics & Có \\
\nolinkurl{VICTORIALOGS_URL} & MqttBridge & URL VictoriaLogs & Có \\
...
tự) & Có \\
\nolinkurl{CORS_ORIGIN} & Backend & URL frontend cho CORS & Có \\
\end{longtable}
}
