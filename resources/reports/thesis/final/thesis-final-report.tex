...
\nolinkurl{mqtt.thingdock.dev} & 443 & tracking-emqx & 8083 & MQTT over WebSocket qua NPM reverse proxy \\\hline
...
\tightlist
\item
  \textbf{URL (cloud/UAT):} \texttt{https://api.thingdock.dev/api-docs}
\item
...
\hline
\endhead
Frontend Web & \nolinkurl{https://thingdock.dev} & admin / Admin@2026 \\\hline
...
Grafana & \nolinkurl{https://grafana.thingdock.dev} & admin / Anmh1205 \\\hline
EMQX Dashboard & \nolinkurl{https://emqx.thingdock.dev} & admin / Anmh1205 \\\hline
NPM Admin & \nolinkurl{https://npm.thingdock.dev} & Tài khoản admin cấu hình khi bootstrap \\\hline
\end{longtable}
}
