...
- Modem LTE + GNSS tích hợp SIMCom SIM7600CE-T
...
| -------------- | --------------------------------------------------- | ------------------------------- |
| Phần cứng      | ESP32-S3, SIM7600CE-T, vgate iCar Pro, LIS3DH       | Thiết kế và chế tạo prototype   |
...
| LTE + GNSS                    | SIMCom SIM7600CE-T              | —        | Truyền dữ liệu 4G và định vị GPS |
...
**Về phần cứng:**
- Thiết kế thành công prototype thiết bị tracker IoT sử dụng ESP32-S3 làm vi điều khiển trung tâm, tích hợp modem SIMCom SIM7600CE-T (LTE + GNSS), adapter OBD2 BLE vgate iCar Pro, cảm biến gia tốc LIS3DH và pin dự phòng 21700.
