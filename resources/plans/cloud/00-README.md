...
9. **UI Enhancement Plans**: Xem `resources/plans/frontend-enhancement/` cho kế hoạch nâng cấp UI chi tiết dựa trên IVM26 reference
...
4.  **Read Specs:** Never guess. Read the `resources/plans/cloud/*.md` files listed below.
...
> *Status: See PROGRESS.md* | *Sub-plans: `../firmware/phases/firmware/`*
...
*   **Separate Coding Plan:** [`firmware/`](../firmware/) — tách riêng khỏi cloud coding-plan
*   **Sub-plans (AUTHORITATIVE):**
    *   [1A-foundation.md](../firmware/phases/firmware/1A-foundation.md)
    *   [2A-ble-obd2.md](../firmware/phases/firmware/2A-ble-obd2.md)
    *   [2B-hardware-drivers.md](../firmware/phases/firmware/2B-hardware-drivers.md)
    *   [2C-modem.md](../firmware/phases/firmware/2C-modem.md)
    *   [3A-communication.md](../firmware/phases/firmware/3A-communication.md)
    *   [4A-integration.md](../firmware/phases/firmware/4A-integration.md)
*   **Reference Specs:** [00-firmware-architecture.md](../firmware/00-firmware-architecture.md), [firmware-development-plan.md](../../reports/system-design/firmware-development/firmware-development-plan.md)
*   **Reference Code:** [esp32-obd2-meter/](../../references/example/esp32-obd2-meter/) (BLE OBD2 reference)
