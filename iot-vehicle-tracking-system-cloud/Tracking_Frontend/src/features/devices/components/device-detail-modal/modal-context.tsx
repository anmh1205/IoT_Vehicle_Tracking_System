...
export interface DeviceDetailModalContextValue {
  ...
  errorCodesLoadedCount: number;
  errorCodesHasMore: boolean;
  errorCodesStatus: 'all' | 'active' | 'resolved';
  errorCodesType: 'all' | 'critical' | 'warning' | 'info';
  onErrorCodesLoadMore: () => void;
  ...
  commandsLoadedCount: number;
  commandsHasMore: boolean;
  onCommandsLoadMore: () => void;
