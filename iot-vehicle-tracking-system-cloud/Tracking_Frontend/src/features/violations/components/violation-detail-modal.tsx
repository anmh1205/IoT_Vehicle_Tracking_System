...
export const ViolationDetailModal = ({
  ...
  const violationTypeLabel =
    VIOLATION_TYPE_LABELS[detail.violationType] ?? detail.violationType ?? 'Chưa xác định';
              ...
              <CardContent className="space-y-3">
                {locationReady ? (
                  ...
                  <div className="rounded-xl border border-dashed px-4 py-6 text-sm text-muted-foreground">
                    Bản ghi vi phạm này chưa có tọa độ hợp lệ. Nên kiểm tra pipeline ingest telemetry khi
                    ghi violation event.
                  </div>
                )}
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">
                  {detail.notes ?? 'Chưa có ghi chú. Nên bổ sung nguyên nhân và hành động đã áp dụng.'}
                </p>
              </CardContent>
            </Card>
