...
const makeIcon = (status: string) =>
  L.divIcon({
    ...
    html: `<div style="width:14px;height:14px;border-radius:999px;background:${status === 'running' ? '#22c55e' : status === 'stopped' ? '#f59e0b' : '#ef4444'};border:2px solid #fff;box-shadow:0 0 0 1px rgba(0,0,0,.2);"></div>`,
    iconSize: [14, 14],
    iconAnchor: [7, 7],
  });
